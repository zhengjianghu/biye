...
extern void newNodeNet(int16u shortid,EmberEUI64 ieee);
extern void formResultInf(EmberStatus status);
extern void pjoinResultInf(EmberStatus status);
extern boolean revCmdInfo(EmberAfClusterCommand* cmd);
