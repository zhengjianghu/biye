...
if [ $SDK_PATH ]; then
    ...
    export SDK_PATH=/mnt/share/ESP8266_RTOS_SDK-1.4.x
fi
echo "SDK_PATH:"
echo "$SDK_PATH"
echo ""
...
cp -f /mnt/share/EmberZNet5.6.0-GA/app/builder/xncp2/build/exe/libxncp2.a $SDK_PATH/examples/project_template/lib/libxncp2.a
make clean
