...
typedef struct {
  ...
  int8u basicDiscoveryLqiThreshold;
  int8u strictDiscoveryLqiThreshold;
...
boolean emRf4ceNcpDiscoveryRequestHandler(EmberEUI64 srcIeeeAddr,
                                          int8u nodeCapabilities,
                                          EmberRf4ceVendorInfo *vendorInfo,
                                          EmberRf4ceApplicationInfo *appInfo,
                                          int8u searchDevType,
...
boolean emRf4ceNcpDiscoveryResponseHandler(boolean atCapacity,
                                           int8u channel,
                                           EmberPanId panId,
                                           EmberEUI64 srcIeeeAddr,
                                           int8u nodeCapabilities,
...
boolean emRf4ceNcpPairRequestHandler(EmberStatus status,
                                     int8u pairingIndex,
                                     EmberEUI64 srcIeeeAddr,
                                     int8u nodeCapabilities,
                                     EmberRf4ceVendorInfo *vendorInfo,
...
void emRf4ceNcpUnpairHandler(int8u pairingIndex);

void emRf4ceNcpUnpairCompleteHandler(int8u pairingIndex);

//------------------------------------------------------------------------------
// Ezsp Command Handlers

EmberStatus emberAfEzspRf4ceDeletePairingTableEntryCommandCallback(int8u pairingIndex);
...
EmberStatus emberAfEzspRf4ceEnableAutoDiscoveryResponseCommandCallback(int16u duration);
