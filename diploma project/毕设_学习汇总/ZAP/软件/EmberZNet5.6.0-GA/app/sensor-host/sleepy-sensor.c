                                ...
                                int8u *message)
{
  ...
  MEMMOVE((int8u*) &eui, message, EUI64_SIZE);
                                      ...
                                      int8s rssi)
{
  ...
  MEMMOVE(networkParams.extendedPanId, extendedPanId, EXTENDED_PAN_ID_SIZE);
...
void sendSinkQuery(void) {
  ...
  // the data
  MEMMOVE(globalBuffer, emberGetEui64(), EUI64_SIZE);
