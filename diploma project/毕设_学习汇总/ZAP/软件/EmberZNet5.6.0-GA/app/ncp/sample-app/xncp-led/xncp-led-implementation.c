...
// LED state.
static int8u ledState;
static int32u ledEventHandlerDelayMS = MILLISECOND_TICKS_PER_SECOND;
                                                         ...
                                                         int8u *replyPayload)
{
  ...
  int8u commandId = messagePayload[LED_PROTOCOL_COMMAND_INDEX];
  ...
  *replyPayloadLength = 0;
  ...
  case LED_PROTOCOL_COMMAND_SET_FREQ: {
    ...
    int32u frequency = emberFetchLowHighInt32u(messagePayload + 1);
