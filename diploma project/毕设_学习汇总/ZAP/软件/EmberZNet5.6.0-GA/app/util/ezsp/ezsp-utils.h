...
#define emberFetchLowHighInt32u(contents)   \
        ((contents)[0]                      \
         + (((int32u)(contents)[1]) << 8)   \
         + (((int32u)(contents)[2]) << 16)  \
         + (((int32u)(contents)[3]) << 24))
...
EmberStatus emberSetOutgoingNwkFrameCounter(int32u* desiredValuePtr);
#else
 ...
 */
#if defined DOXYGEN_SHOULD_SKIP_THIS
EmberStatus emberSetOutgoingApsFrameCounter(int32u* desiredValuePtr);
#else
