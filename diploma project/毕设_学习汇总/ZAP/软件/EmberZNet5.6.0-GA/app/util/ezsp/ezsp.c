...
EmberStatus emberFindAndRejoinNetworkWithNodeType(boolean haveCurrentNetworkKey,
                                                  int32u channelMask,
...
{
  int8u sourceRouteOverhead = EZSP_SOURCE_ROUTE_OVERHEAD_UNKNOWN;
