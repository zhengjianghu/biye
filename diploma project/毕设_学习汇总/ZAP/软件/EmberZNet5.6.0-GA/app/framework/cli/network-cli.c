...
{
  boolean haveCurrentNetworkKey = (int8u)emberUnsignedCommandArgument(0);
  int32u channelMask = (int32u)emberUnsignedCommandArgument(1);
  int8u emberNodeType = (int8u)emberUnsignedCommandArgument(2); 
...
void networkExtendedPanIdCommand(void)
{
  ...
  emberCopyBigEndianEui64Argument(0, extendedPanId);
