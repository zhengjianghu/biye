...
#else
typedef int8u EmberAfPluginPriceCppAuth;
enum
#endif
{
...
#else
typedef int16u EmberAfDeviceManagementPasswordType;
enum 
#endif
{
...
#else
typedef int8u EmberAfDeviceManagementChangePendingFlags;
enum 
#endif
{
...
typedef struct {
  ...
  int8u proposedProviderName[EMBER_AF_DEVICE_MANAGEMENT_MAXIMUM_PROPOSED_PROVIDER_NAME_LENGTH + 1];
  int8u proposedProviderContactDetails[EMBER_AF_DEVICE_MANAGEMENT_MAXIMUM_PROPOSED_PROVIDER_CONTACT_DETAILS_LENGTH + 1];
...
typedef struct {
  int8u cin[EMBER_AF_DEVICE_MANAGEMENT_MAXIMUM_CIN_LENGTH + 1];
  int32u implementationDateTime;
  int32u issuerEventId;
...
typedef struct {
  ...
  int8u * plainData;
  int16u plainDataLength;

  int8u * encryptedData;
  int16u encryptedDataLength;
 ...
 */
typedef int16u EmberAfRemoteClusterType;
