...
#if defined(EMBER_AF_PLUGIN_NETWORK_STEERING)
  // Hack.  We should find a more elegant way to set this policy.
 // state.bitmask |= EMBER_GET_LINK_KEY_WHEN_JOINING;
#endif
...
#if defined(EMBER_AF_PLUGIN_NETWORK_STEERING)
  newExtended |= EMBER_VERIFY_REQUESTED_LINK_KEY;
#endif  
