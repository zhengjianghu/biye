...
static EmberStatus permitRequestingTrustCenterLinkKey(void)
{
  ...
  EzspDecisionId emberAfLinkKeyRequestPolicy;
#if defined(EMBER_AF_PLUGIN_NETWORK_COMMISSIONER)
  emberAfLinkKeyRequestPolicy = EMBER_GENERATE_NEW_TC_LINK_KEY;
#else
emberAfLinkKeyRequestPolicy = data->tcLinkKeyRequestPolicy;
#endif
  return emberAfSetEzspPolicy(EZSP_TC_KEY_REQUEST_POLICY,
                              emberAfLinkKeyRequestPolicy,
                              "TC Key Request",
                              (emberAfLinkKeyRequestPolicy
