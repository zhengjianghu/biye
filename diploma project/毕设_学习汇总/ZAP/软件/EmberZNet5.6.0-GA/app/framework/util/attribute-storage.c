...
PGM int8u generatedDefaults[]               = GENERATED_DEFAULTS;
...
PGM int16u clusterManufacturerCodeCount = GENERATED_CLUSTER_MANUFACTURER_CODE_COUNT;
PGM EmberAfManufacturerCodeEntry attributeManufacturerCodes[] = GENERATED_ATTRIBUTE_MANUFACTURER_CODES;
PGM int16u attributeManufacturerCodeCount = GENERATED_ATTRIBUTE_MANUFACTURER_CODE_COUNT;
...
void emberAfSetEndpointCount(int8u dynamicEndpointCount)
{
  emberEndpointCount = FIXED_ENDPOINT_COUNT + dynamicEndpointCount;
}

int8u emberAfFixedEndpointCount(void)
{
...
EmberAfStatus emAfClusterPreAttributeChangedCallback(int8u endpoint,
                                                     EmberAfClusterId clusterId,
                                                     EmberAfAttributeId attributeId,
                                                     int8u clientServerMask,
                                                     int16u manufacturerCode,
...
int8u emberAfGetClusterCountForEndpoint(int8u endpoint)
{
  int8u index = emberAfIndexFromEndpoint(endpoint);
  if ( index == 0xFF) {
    return 0;
...
//
// Don't mix them.
EmberAfCluster* emberAfGetClusterByIndex(int8u endpoint, int8u clusterIndex)
{
...
EmberAfProfileId emberAfGetProfileIdForEndpoint(int8u endpoint)
{
  int8u endpointIndex = emberAfIndexFromEndpoint(endpoint);
  if (endpointIndex == 0xFF) {
...
int16u emberAfGetDeviceIdForEndpoint(int8u endpoint)
{
  int8u endpointIndex = emberAfIndexFromEndpoint(endpoint);
  if (endpointIndex == 0xFF) {
    return EMBER_AF_INVALID_PROFILE_ID;
...
int8u emberAfGetClustersFromEndpoint(int8u endpoint, EmberAfClusterId *clusterList, int8u listLen, boolean server) {
...
void emberAfInitializeAttributes(int8u endpoint)
{
...
void emAfLoadAttributeDefaults(int8u endpoint, boolean writeTokens)
{
...
void emAfLoadAttributesFromTokens(int8u endpoint)
{
...
void emAfSaveAttributeToToken(int8u *data,
                              int8u endpoint,
                              EmberAfClusterId clusterId,
                              EmberAfAttributeMetadata *metadata)
{
