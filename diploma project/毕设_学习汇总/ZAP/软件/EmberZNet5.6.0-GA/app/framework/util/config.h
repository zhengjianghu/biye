...
//     for use in the App Framework (AF).  If not set by AppBuilder we default it
//     here.  Normally it is set in AppBuilder according to the allocation for
//     the company by the Zigbee Alliance.
...
#define EMBER_COMPANY_MANUFACTURER_CODE 0x1002
  ...
  #define EMBER_AF_MANUFACTURER_CODE EMBER_COMPANY_MANUFACTURER_CODE
#endif
...
#define EZSP_APPLICATION_HAS_BUTTON_HANDLER
  ...
  #define EMBER_AF_MESSAGE_SENT_CALLBACK_TABLE_SIZE 3
