...
PGM_P emberAfGetEventString(int8u index)
{
  return (index == 0XFF
...
EmberStatus emberAfScheduleTickExtended(int8u endpoint,
                                        EmberAfClusterId clusterId,
                                        boolean isClient,
                                        int32u delayMs,
...
EmberStatus emberAfScheduleClientTickExtended(int8u endpoint,
                                              EmberAfClusterId clusterId,
                                              int32u delayMs,
                                              EmberAfEventPollControl pollControl,
                                              EmberAfEventSleepControl sleepControl)
...
EmberStatus emberAfScheduleClientTick(int8u endpoint,
                                      EmberAfClusterId clusterId,
                                      int32u delayMs)
{
...
EmberStatus emberAfScheduleServerTickExtended(int8u endpoint,
                                              EmberAfClusterId clusterId,
                                              int32u delayMs,
                                              EmberAfEventPollControl pollControl,
                                              EmberAfEventSleepControl sleepControl)
...
EmberStatus emberAfScheduleServerTick(int8u endpoint,
                                      EmberAfClusterId clusterId,
                                      int32u delayMs)
{
...
EmberStatus emberAfDeactivateClientTick(int8u endpoint,
                                        EmberAfClusterId clusterId)
{
...
EmberStatus emberAfDeactivateServerTick(int8u endpoint,
                                        EmberAfClusterId clusterId)
{
  return emberAfDeactivateClusterTick(endpoint,
                                      clusterId,
