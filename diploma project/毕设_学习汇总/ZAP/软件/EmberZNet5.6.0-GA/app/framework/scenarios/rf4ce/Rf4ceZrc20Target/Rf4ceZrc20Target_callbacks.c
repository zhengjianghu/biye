...
static int16u appClusterIds[] = {ZCL_ON_OFF_CLUSTER_ID};
...
static int8u selectedLight = 0;

static int8u theirPairingIndex = 0;
static int8u theirHaInstanceId = 0;
static int8u theirBindingIndex = EMBER_NULL_BINDING;
static int8u numCount = 0;
...
static void userControlPressed(int8u pairingIndex,
...
{
  boolean setPending = (halButtonState(BUTTON) == BUTTON_PRESSED);
...
static void haFindLight(void)
{
    int8u endpoint = emberAfPrimaryEndpoint();
    EmberStatus status;
