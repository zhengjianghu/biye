...
int8u emAfZrcState = ZRC_STATE_INITIAL;
...
boolean emberAfPluginRf4ceProfileZrc20DiscoveryRequestCallback(const EmberEUI64 ieeeAddr,
                                                               int8u nodeCapabilities,
                                                               const EmberRf4ceVendorInfo *vendorInfo,
                                                               const EmberRf4ceApplicationInfo *appInfo,
                                                               int8u searchDevType,
...
boolean emberAfPluginRf4ceProfileZrc20DiscoveryResponseCallback(boolean atCapacity,
                                                                int8u channel,
                                                                EmberPanId panId,
                                                                const EmberEUI64 ieeeAddr,
                                                                int8u nodeCapabilities,
...
boolean emberAfPluginRf4ceProfileZrc20PairRequestCallback(EmberStatus status,
                                                          int8u pairingIndex,
                                                          const EmberEUI64 sourceIeeeAddr,
                                                          int8u nodeCapabilities,
                                                          const EmberRf4ceVendorInfo *vendorInfo,
...
boolean emberAfPluginRf4ceGdpZrc20StartConfigurationCallback(boolean isOriginator,
                                                             int8u pairingIndex)
{
  if (isOriginator) {
...
//static void printActionBanksSupported(const int8u *actionBanksSupported)
//{
//  int8u i;
...
void emAfRf4ceZrcClearActionBank(int8u *actionBanksSupported,
                                 EmberAfRf4ceZrcActionBank actionBank)
{
  int8u byte = ACTION_BYTE(actionBank);
  int8u bit = ACTION_BIT(actionBank);
...
boolean emAfRf4ceZrcReadActionBank(const int8u *actionBanksSupported,
                                   EmberAfRf4ceZrcActionBank actionBank)
{
  int8u byte = ACTION_BYTE(actionBank);
  int8u bit = ACTION_BIT(actionBank);
...
void emAfRf4ceZrcSetActionBank(int8u *actionBanksSupported,
                               EmberAfRf4ceZrcActionBank actionBank)
{
  int8u byte = ACTION_BYTE(actionBank);
  int8u bit = ACTION_BIT(actionBank);
...
boolean emAfRf4ceZrcHasRemainingActionBanks(const int8u *actionBanksSupported)
{
  int8u i;
  for (i = 0; i < ZRC_BITMASK_SIZE; i++) {
...
void emAfRf4ceZrcGetExchangeableActionBanks(const int8u *actionBanksSupportedTx,
                                            EmberAfRf4ceZrcCapability originatorCapabilities,
                                            const int8u *actionBanksSupportedRx,
                                            EmberAfRf4ceZrcCapability recipientCapabilities,
                                            int8u *actionBanksSupportedRxExchange,
                                            int8u *actionBanksSupportedTxExchange)
{
  int8u actionBanksSupportedCommon[ZRC_BITMASK_SIZE];
  int8u i;
