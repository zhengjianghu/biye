...
static const int8u standardSharedSecret[GDP_SHARED_SECRET_SIZE] =
    GDP_STANDARD_SHARED_SECRET;
static const char *context = "RF4CE GDP";

static boolean internalCall;
static int8u securityPairingIndex;
...
static EmberAfRf4ceGdpKeyExchangeFlags
                 getKeyExchangeParams(boolean localNodeIsInitiator,
                                      EmberAfRf4ceGdpKeyExchangeFlags peerFlags,
                                      int8u *vendorSpecificSecret);
static void computeTag(boolean isTagA, int8u pairingIndex, int8u *tag);
static boolean generateKey(boolean localNodeIsInitiator,
                           int8u pairingIndex,
                           const int8u *sharedSecret,
                           int8u *generatedKey);
static boolean updateLinkKeyAndResetFrameCounter(void);
                                              ...
                                              const EmberAfRf4ceGdpRand *randA)
{
  ...
  int8u vendorSpecificSecret[GDP_SHARED_SECRET_SIZE];
...
void finishSecurityProcedure(EmberStatus status)
{
  int16u savedInternalState = internalGdpState();
                                      ...
                                      int8u *vendorSpecificSecret)
{
  ...
  int8u peerVendorSpecificParam =
      (int8u)(peerFlags >> EMBER_AF_RF4CE_GDP_KEY_EXCHANGE_FLAG_VENDOR_SPECIFIC_PARAMETER_OFFSET);
  int8u localVendorSpecificParam;
...
static void computeTag(boolean isTagA, int8u pairingIndex, int8u *tag)
{
  int8u message[EMBER_AF_RF4CE_GDP_RAND_SIZE*2];
  int8u hashedMessage[EMBER_AF_RF4CE_GDP_RAND_SIZE*2];
                           ...
                           int8u *generatedKey)
{
  ...
  EmberEUI64 macA;
  EmberEUI64 macB;
  int8u k_dk[EMBER_ENCRYPTION_KEY_SIZE];
  int8u aux[CONTEXT_STRING_LENGTH + 2*EUI64_SIZE + EMBER_ENCRYPTION_KEY_SIZE];
