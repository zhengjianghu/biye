...
static int8u findDeviceLogEntry(EmberEUI64 deviceId);
static int8u findFreeDeviceLogEntry(void);
...
int8u emberAfPluginGbcsDeviceLogMaxSize(void)
{
  return EMBER_AF_PLUGIN_GBCS_DEVICE_LOG_DEVICE_LOG_SIZE;
}

int8u emberAfPluginGbcsDeviceLogCount(void)
{
  int8u i;
  int8u count = 0;
...
boolean emberAfPluginGbcsDeviceLogStore(EmberEUI64 deviceId,
                                        EmberAfGBCSDeviceLogInfo *deviceInfo)
{
  int8u i;
...
boolean emberAfPluginGbcsDeviceLogRemove(EmberEUI64 deviceId)
{
  int8u i;
...
boolean emberAfPluginGbcsDeviceLogRetrieveByIndex(int8u index,
...
boolean emberAfPluginGbcsDeviceLogGet(EmberEUI64 deviceId,
                                      EmberAfGBCSDeviceLogInfo *deviceInfo)
{
  int8u i;
...
boolean emberAfPluginGbcsDeviceLogExists(EmberEUI64 deviceId,
