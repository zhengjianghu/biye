...
void emAfRf4ceZrc20IncomingMessage(int8u pairingIndex,
                                   int16u vendorId,
                                   const int8u *message,
                                   int8u messageLength);
...
void emAfRf4ceZrcIncomingRequestSelectiveActionMappingUpdate(const int8u *mappableActionsList,
                                                             int8u mappableActionsListLength);
