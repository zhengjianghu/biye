...
#else
typedef int8u EmberAfRf4ceMsoIrRfDatabaseFlags;
enum
#endif
{
  /** No flags. */
...
#else
typedef int8u EmberAfRf4ceMsoIrRfDatabaseDeviceType;
enum
#endif
{
...
#else
typedef int8u EmberAfRf4ceMsoIrRfDatabaseRfConfig;
enum
#endif
{
...
#else
typedef int8u EmberAfRf4ceMsoIrRfDatabaseIrConfig;
enum
#endif
{
