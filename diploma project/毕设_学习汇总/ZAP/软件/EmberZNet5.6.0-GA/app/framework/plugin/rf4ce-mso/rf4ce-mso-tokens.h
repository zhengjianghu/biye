// Copyright 2013 Silicon Laboratories, Inc.
  ...
  #define CREATOR_PLUGIN_RF4CE_MSO_ATTRIBUTE_GENERAL_PURPOSE              0x8734
    ...
    typedef int8u tokMsoAttributeRfStatistics[MSO_RIB_ATTRIBUTE_RF_STATISTICS_LENGTH];
    typedef int8u tokMsoAttributeVersioning[MSO_ATTRIBUTE_VERSIONING_ENTRIES][MSO_RIB_ATTRIBUTE_VERSIONING_LENGTH];
    typedef int8u tokMsoAttributeBatteryStatus[MSO_RIB_ATTRIBUTE_BATTERY_STATUS_LENGTH];
    typedef int8u tokMsoAttributeShortRfRetryPeriod[MSO_RIB_ATTRIBUTE_SHORT_RF_RETRY_PERIOD_LENGTH];
    typedef int8u tokMsoAttributeValidationConfiguration[MSO_RIB_ATTRIBUTE_VALIDATION_CONFIGURATION_LENGTH];
    typedef int8u tokMsoAttributeGeneralPurpose[EMBER_AF_PLUGIN_RF4CE_MSO_GENERAL_PURPOSE_ENTRIES][MSO_RIB_ATTRIBUTE_GENERAL_PURPOSE_LENGTH];
  #endif
  #ifdef DEFINETOKENS
