...
void emberAfPluginRf4ceMsoNcpInitCallback(boolean memoryAllocation)
{

  if (!memoryAllocation) {
    int8u msoUserString[MSO_USER_STRING_LENGTH]
    ...
    {
      int8u bindingParams[MSO_SET_VALUE_BINDING_RECIPIENT_PARAMETERS_BYTES_LENGTH];
