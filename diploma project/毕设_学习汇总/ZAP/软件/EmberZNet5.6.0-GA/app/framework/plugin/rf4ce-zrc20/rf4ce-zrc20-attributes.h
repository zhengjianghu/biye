...
typedef struct {
  int8u contents[ZRC_BITMASK_SIZE];
} EmAfZrcBitmask;
...
typedef struct {
  // Scalar
  int16u zrcProfileVersion;
  int16u zrcActionBanksVersion;
  EmAfZrcBitmask *actionBanksSupportedRx;
  EmAfZrcBitmask *actionBanksSupportedTx;
#if (defined(EMBER_AF_PLUGIN_RF4CE_ZRC20_LOCAL_IRDB_VENDOR_ATTRIBUTE_SUPPORT)  \
     || defined(EMBER_AF_PLUGIN_RF4CE_ZRC20_REMOTE_IRDB_VENDOR_ATTRIBUTES_SUPPORT) \
     || defined(EMBER_SCRIPTED_TEST))
  int16u *IRDBVendorSupport;
#endif
...
extern int32u localNodeZrcCapabilities;
...
#define emAfRf4ceZrcGetRemoteNodeCapabilities(pairingIndex)                    \
    ((int32u)((emAfRf4ceZrcGetRemoteNodeFlags(pairingIndex)                    \
...
int8u *emAfRf4ceZrcGetArrayedAttributePointer(int8u attrId,
                                              int16u entryId,
                                              int8u pairingIndex,
                                              int8u *index);
