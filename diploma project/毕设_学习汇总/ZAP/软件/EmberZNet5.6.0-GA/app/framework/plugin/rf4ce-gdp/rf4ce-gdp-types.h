...
#else
typedef int8u EmberAfRf4ceGdpResponseCode;
enum
#endif
{
...
#else
typedef int8u EmberAfRf4ceGdpStatus;
enum
#endif
{
...
#else
typedef int8u EmberAfRf4ceGdpHeartbeatTrigger;
enum
#endif
{
 ...
 * heartbeat trigger.
 */
typedef void (*EmberAfRf4ceGdpHeartbeatCallback)(int8u, EmberAfRf4ceGdpHeartbeatTrigger);
...
#else
typedef int8u EmberAfRf4ceGdpAttributeId;
enum
#endif
{
...
#else
typedef int8u EmberAfRf4ceGdpAttributeStatus;
enum
#endif
{
...
#else
typedef int8u EmberAfRf4ceGdpCheckValidationSubtype;
enum
#endif
{
...
#else
typedef int8u EmberAfRf4ceGdpCheckValidationStatus;
enum
#endif
{
...
#else
typedef int8u EmberAfRf4ceGdpClientNotificationSubtype;
enum
#endif
{
...
#else
typedef int8u EmberAfRf4ceGdpClientNotificationIdentifyFlags;
enum
#endif
{
...
#else
typedef int8u EmberAfRf4ceGdpKeyExchangeSubtype;
enum
#endif
{
...
#else
typedef int16u EmberAfRf4ceGdpKeyExchangeFlags;
enum
#endif
{
...
typedef struct {
  ...
  int8u contents[EMBER_AF_RF4CE_GDP_RAND_SIZE];
} EmberAfRf4ceGdpRand;
...
typedef struct {
  ...
  int8u contents[EMBER_AF_RF4CE_GDP_TAG_SIZE];
} EmberAfRf4ceGdpTag;
...
#else
typedef int8u EmberAfRf4ceGdpBindingStatus;
enum
#endif
{
...
#else
typedef int16u EmberAfRf4ceGdpPollingTrigger;
enum
#endif
{
...
#else
typedef int8u EmberAfRf4ceGdpPollingMethod;
enum
#endif
{
