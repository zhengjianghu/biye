...
int8u emAfRf4ceZrc11Buffer[EMBER_AF_PLUGIN_RF4CE_ZRC11_MAXIMUM_PAYLOAD_LENGTH];
int8u emAfRf4ceZrc11BufferLength;

EmberEventControl emberAfPluginRf4ceZrc11CommandDiscoveryEventControl;
static int8u commandDiscoveryPairingIndex = 0xFF;
...
EmberStatus emAfRf4ceZrc11Send(int8u pairingIndex)
{
