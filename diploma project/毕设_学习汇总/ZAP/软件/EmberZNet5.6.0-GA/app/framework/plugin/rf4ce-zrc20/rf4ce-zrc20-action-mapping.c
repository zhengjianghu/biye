...
static int8u negotiationPairingIndex;
static int16u mappableActionIndex = 0;
static boolean pushMappableActionsToServer(void);
...
static boolean pushMappableActionsToServer(void)
{
  ...
  int16u vendorId = EMBER_RF4CE_NULL_VENDOR_ID; // TODO: vendor ID?
  ...
  record.value = (int8u*)(&mappableAction);
...
{
  EmberAfRf4ceGdpAttributeRecord record;
  int8u irdbVendorSupport[EMBER_AF_RF4CE_ZRC_IRDB_VENDOR_ID_COUNT*2];
