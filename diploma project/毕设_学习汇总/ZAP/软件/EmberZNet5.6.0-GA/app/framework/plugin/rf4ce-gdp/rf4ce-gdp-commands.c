...
int8u emAfRf4ceGdpOutgoingCommandFrameControl =
...
static Decision checkCommand(int8u pairingIndex,
                             int8u profileId,
                             int16u vendorId,
                             const int8u *message,
                             int8u messageLength,
                             boolean rx);
static EmberStatus send(int8u pairingIndex, int8u profileId, int16u vendorId);
...
static int8u buffer[EMBER_AF_RF4CE_MAXIMUM_RF4CE_PAYLOAD_LENGTH];
static int8u bufferLength = 0;

static const int8u *incoming = NULL;
static int8u incomingLength = 0;
static int8u incomingOffset = 0xFF;

boolean emberAfPluginRf4ceProfileGdpMessageSentCallback(int8u pairingIndex,
                                                        int8u profileId,
                                                        int16u vendorId,
                                                        int8u messageTag,
                                                        const int8u *message,
...
boolean emberAfRf4ceGdpMessageSent(int8u pairingIndex,
                                   int8u profileId,
                                   int16u vendorId,
                                   const int8u *message,
                                   int8u messageLength,
...
boolean emberAfPluginRf4ceProfileGdpIncomingMessageCallback(int8u pairingIndex,
                                                            int8u profileId,
                                                            int16u vendorId,
...
boolean emberAfRf4ceGdpIncomingMessage(int8u pairingIndex,
                                       int8u profileId,
                                       int16u vendorId,
                                       EmberRf4ceTxOption txOptions,
                                       const int8u *message,
  ...
  case EMBER_AF_RF4CE_GDP_COMMAND_KEY_EXCHANGE:
    {
      ...
      if (subtype == EMBER_AF_RF4CE_GDP_KEY_EXCHANGE_SUBTYPE_CHALLENGE
        ...
        boolean secured = (txOptions & EMBER_RF4CE_TX_OPTIONS_SECURITY_ENABLED_BIT) > 0;
  ...
  if (callback != NULL) {
    ...
    case EMBER_AF_RF4CE_GDP_COMMAND_CLIENT_NOTIFICATION:
      if (CLIENT_NOTIFICATION_LENGTH <= messageLength) {
        ((void (*) (EmberAfRf4ceGdpClientNotificationSubtype, const int8u*, int8u))*callback)
...
EmberStatus emberAfRf4ceGdpGenericResponse(int8u pairingIndex,
                                           int8u profileId,
                                           int16u vendorId,
...
EmberStatus emberAfRf4ceGdpConfigurationComplete(int8u pairingIndex,
                                                 int8u profileId,
                                                 int16u vendorId,
...
EmberStatus emberAfRf4ceGdpHeartbeat(int8u pairingIndex,
                                     int16u vendorId,
...
EmberStatus emberAfRf4ceGdpGetAttributes(int8u pairingIndex,
                                         int8u profileId,
                                         int16u vendorId,
                                         const EmberAfRf4ceGdpAttributeIdentificationRecord *records,
                                         int8u recordsLength)
...
EmberStatus emberAfRf4ceGdpGetAttributesResponse(int8u pairingIndex,
                                                 int8u profileId,
                                                 int16u vendorId,
                                                 const EmberAfRf4ceGdpAttributeStatusRecord *records,
                                                 int8u recordsLength)
...
EmberStatus emberAfRf4ceGdpPushAttributes(int8u pairingIndex,
                                          int8u profileId,
                                          int16u vendorId,
                                          const EmberAfRf4ceGdpAttributeRecord *records,
                                          int8u recordsLength)
...
EmberStatus emberAfRf4ceGdpSetAttributes(int8u pairingIndex,
                                         int8u profileId,
                                         int16u vendorId,
                                         const EmberAfRf4ceGdpAttributeRecord *records,
                                         int8u recordsLength)
...
EmberStatus emberAfRf4ceGdpPullAttributes(int8u pairingIndex,
                                          int8u profileId,
                                          int16u vendorId,
                                          const EmberAfRf4ceGdpAttributeIdentificationRecord *records,
                                          int8u recordsLength)
...
EmberStatus emberAfRf4ceGdpPullAttributesResponse(int8u pairingIndex,
                                                  int8u profileId,
                                                  int16u vendorId,
                                                  const EmberAfRf4ceGdpAttributeStatusRecord *records,
                                                  int8u recordsLength)
...
EmberStatus emberAfRf4ceGdpCheckValidationRequest(int8u pairingIndex,
                                                  int16u vendorId,
                                                  int8u control)
{
  bufferLength = 0;
...
EmberStatus emberAfRf4ceGdpCheckValidationResponse(int8u pairingIndex,
                                                   int16u vendorId,
...
EmberStatus emberAfRf4ceGdpClientNotificationIdentify(int8u pairingIndex,
                                                      int16u vendorId,
...
EmberStatus emberAfRf4ceGdpClientNotificationRequestPollNegotiation(int8u pairingIndex,
                                                                    int16u vendorId)
{
  bufferLength = 0;
  buffer[bufferLength++] = (EMBER_AF_RF4CE_GDP_COMMAND_CLIENT_NOTIFICATION
...
EmberStatus emberAfRf4ceGdpClientNotification(int8u pairingIndex,
                                              int8u profileId,
                                              int16u vendorId,
                                              int8u subtype,
                                              const int8u *payload,
...
EmberStatus emAfRf4ceGdpKeyExchangeChallenge(int8u pairingIndex,
                                             int16u vendorId,
...
EmberStatus emAfRf4ceGdpKeyExchangeChallengeResponse(int8u pairingIndex,
                                                     int16u vendorId,
                                                     EmberAfRf4ceGdpKeyExchangeFlags flags,
...
EmberStatus emAfRf4ceGdpKeyExchangeResponse(int8u pairingIndex,
                                            int16u vendorId,
...
EmberStatus emAfRf4ceGdpKeyExchangeConfirm(int8u pairingIndex,
                                           int16u vendorId)
{
  bufferLength = 0;
  buffer[bufferLength++] = (EMBER_AF_RF4CE_GDP_COMMAND_KEY_EXCHANGE
...
EmberStatus emAfRf4ceGdpSendAttributesCommand(int8u pairingIndex,
                                              int8u profileId,
                                              int16u vendorId)
{
  return send(pairingIndex, profileId, vendorId);
...
EmberStatus emAfRf4ceGdpSendProfileSpecificCommand(int8u pairingIndex,
                                                   int8u profileId,
                                                   int16u vendorId,
                                                   EmberRf4ceTxOption txOptions,
                                                   int8u commandId,
...
boolean emAfRf4ceGdpAppendAttributeIdentificationRecord(const EmberAfRf4ceGdpAttributeIdentificationRecord *record)
{
...
boolean emAfRf4ceGdpFetchAttributeIdentificationRecord(EmberAfRf4ceGdpAttributeIdentificationRecord *record)
{
...
boolean emAfRf4ceGdpAppendAttributeStatusRecord(const EmberAfRf4ceGdpAttributeStatusRecord *record)
{
  if (sizeof(buffer) < bufferLength + 1) {
    return FALSE;
  }
...
boolean emAfRf4ceGdpFetchAttributeStatusRecord(EmberAfRf4ceGdpAttributeStatusRecord *record)
{
  if (incomingLength < incomingOffset + 1) {
    return FALSE;
  }
...
boolean emAfRf4ceGdpAppendAttributeRecord(const EmberAfRf4ceGdpAttributeRecord *record)
{
  if (sizeof(buffer) < bufferLength + 1) {
    return FALSE;
  }
...
boolean emAfRf4ceGdpFetchAttributeRecord(EmberAfRf4ceGdpAttributeRecord *record)
{
  if (incomingLength < incomingOffset + 1) {
    return FALSE;
  }
...
Parcel *makeGenericResponseParcel(int8u responseCode)
{
  return makeMessage("11",
...
Parcel *makeConfigurationCompleteParcel(int8u status)
{
  return makeMessage("11",
...
Parcel *makeKeyExchangeChallengeParcel(int16u flags, int8u *randA)
{
...
Parcel *makeKeyExchangeChallengeResponseParcel(int16u flags, int8u *randB, int8u *tagB)
{
...
Parcel *makeKeyExchangeResponseParcel(int8u *tagA)
{
