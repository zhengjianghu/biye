 ...
 */
EmberStatus emberAfRf4ceZrc20StartActionMappingsNegotiation(int8u pairingIndex);
 ...
 *
 * @return int8u* Returns a pointer to the first byte of the command discovery
 * value.
 */
#ifdef DOXYGEN_SHOULD_SKIP_THIS
  int8u *emberAfRf4ceZrcCommandsSupportedContents(EmberAfRf4ceZrcCommandsSupported *commandsSupported);
#else
   ...
   * FALSE otherwise.
   */
  boolean emberAfRf4ceZrc20ActionMappingEntryHasRfDescriptor(const EmberAfRf4ceZrcActionMapping *entry);
#else
   ...
   * FALSE otherwise.
   */
  boolean emberAfRf4ceZrc20ActionMappingEntryHasIrDescriptor(const EmberAfRf4ceZrcActionMapping *entry);
#else
   ...
   * otherwise.
   */
  boolean emberAfRf4ceZrc20ActionMappingEntryHasIrVendorId(const EmberAfRf4ceZrcActionMapping *entry);
#else
