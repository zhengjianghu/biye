                                                         ...
                                                         int8u *snapshotCriteria)
{
  ...
  int32u startTime = emberAfGetInt32u(snapshotCriteria, 0, 13);
  int32u endTime = emberAfGetInt32u(snapshotCriteria, 4, 13);
  int8u snapshotOffset = emberAfGetInt8u(snapshotCriteria, 8, 13);
  int32u snapshotCause = emberAfGetInt32u(snapshotCriteria, 9, 13);
