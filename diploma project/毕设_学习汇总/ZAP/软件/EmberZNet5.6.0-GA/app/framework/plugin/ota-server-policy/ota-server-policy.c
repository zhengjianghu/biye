...
static int16u imageBlockRequestMinRequestPeriodMS = 0;
...
void emAfOtaServerPolicyPrint(void)
{
  ...
  otaPrintln("Image Block Request Min Period: %d milliseconds",
             imageBlockRequestMinRequestPeriodMS);
  emberAfCoreFlush();
...
int8u emAfOtaServerImageBlockRequestCallback(EmberAfImageBlockRequestCallbackStruct* data)
{
  if (SERVER_AND_CLIENT_SUPPORT_MIN_BLOCK_REQUEST
    ...
    if (data->minBlockRequestPeriod != imageBlockRequestMinRequestPeriodMS) {
      data->minBlockRequestPeriod = imageBlockRequestMinRequestPeriodMS;
...
void emAfOtaServerPolicySetMinBlockRequestPeriod(int16u minBlockRequestPeriodMS)
{
  imageBlockRequestMinRequestPeriodMS = minBlockRequestPeriodMS;
}
