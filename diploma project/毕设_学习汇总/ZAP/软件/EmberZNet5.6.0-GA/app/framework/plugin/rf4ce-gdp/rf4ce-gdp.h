 ...
 *
 * @return int8u* Returns a pointer to the first byte of the random byte string.
 */
#ifdef DOXYGEN_SHOULD_SKIP_THIS
int8u *emberAfRf4ceGdpRandContents(EmberAfRf4ceGdpRand *rand);
#else
 ...
 *
 * @return int8u* Returns a pointer to the first byte of the tag value.
 */
#ifdef DOXYGEN_SHOULD_SKIP_THIS
int8u *emberAfRf4ceGdpTagContents(EmberAfRf4ceGdpTag *tag);
#else
 ...
 */
void emberAfRf4ceGdpPushButton(boolean setPending);
 ...
 * executed.
 */
EmberStatus emberAfRf4ceGdpInitiateKeyExchange(int8u pairingIndex);
