...
// Internal Functions
static int16u findUseCaseDescription(int16u messageCode) {
  int16u index;
...
// plugin gas-proxy-function simulate-gbz-msg <int16u:messageCode>
void emAfPluginGasProxyFunctionCliSimulateGbzMsg(void)
{
  int16u messageCode = (int16u)emberUnsignedCommandArgument(0);
  int32u currentTime = emberAfGetCurrentTime();

  int16u index = findUseCaseDescription(messageCode);
  ...
  if (messageCode == GCS23_MESSAGE_CODE){
    // Command
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x02, // component count

                             // component #1 - PublishCalorificValue
                              0x00, // extended header control field
                              0x00, 0x07, // extended header cluster id
                              0x11, 0x00, // extended gbz command length
                              0x09, // frame control
                              ...
                              0x00, 0x07, // extended header cluster id
                              0x10, 0x00, // extended gbz command length
                              0x09, // frame control
    ...
    // Normal Response
    int8u gbzCommandResp[] = { 0x09, 0x01, // profile id
                                 0x02, // component count

                                  // component #1 - PublishConversionFactor
                                  0x00, // extended header control field
                                  0x00, 0x07, // extended header cluster id
                                  0x05, 0x00, // extended gbz command length
                                  0x00, // frame control
                                  0x00, // trans. seq number
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x01, // component count
                              ...
                              0x01, // extended header control field
                              0x00, 0x07, // extended header cluster id
                              0x0D, 0x00, // extended gbz command length
                              0x01, // frame control
                              0x00, // trans. seq number
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x0A, // component count
                              ...
                              0x19, 0x00, // extended gbz command length
                              0x09, // frame control
                              0x00, // trans. seq number
                              ...
                              0x07, 0x07, // extended header cluster id
                              0x1D, 0x00, // extended gbz command length
                              0x09, // frame control
                              0x01, // trans. seq number
                              ...
                              0x07, 0x07, // extended header cluster id
                              0x17, 0x00, // extended gbz command length
                              0x09, // frame control
                              ...
                              0x07, 0x07, // extended header cluster id
                              0x25, 0x00, // extended gbz command length
                              0x09, // frame control
                              ...
                              0x07, 0x07, // extended header cluster id
                              0x21, 0x00, // extended gbz command length
                              0x09, // frame control
                              ...
                              0x00, 0x07, // extended header cluster id
                              0x26, 0x00, // extended gbz command length
                              0x09, // frame control
                              ...
                              0x00, 0x07, // extended header cluster id
                              0x23, 0x00, // extended gbz command length
                              0x09, // frame control
                              ...
                              0x00, 0x07, // extended header cluster id
                              0x1B, 0x00, // extended gbz command length
                              0x09, // frame control
                              ...
                              0x00, // command index
                              0x01, // total number of commands
                              0x00, // sub-payload control - Block thresholds apply to all TOU tiers / block only charging in operation
                              0x01, // tier block 1
    ...
    int8u gbzCommandResp[] = { 0x09, 0x01, // profile id
                                 0x0A, // component count
                                  ...
                                  0x00, // extended header control field
                                  0x07, 0x07, // extended header cluster id
                                  0x05, 0x00, // extended header gbz command length
                                  0x00, // frame control
                                  0x01, // trans. seq number
                                  0x0B, // ZCL command id - default response
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x01, // component count
                              ...
                              0x01, // extended header control field
                              0x03, 0x07, // extended header cluster id
                              0x18, 0x00, // extended gbz command length
                              0x09, // frame control
                              0x00, // trans. seq number
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x01, // component count
                              ...
                              // component #1
                              0x01, // extended header control field
                              0x02, 0x07, // extended header cluster id
                              0x0C, 0x00, // extended gbz command length
                              0x11, // frame control
                              0x00, // trans. seq number
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x01, // component count
                              ...
                              0x01, // extended header control field
                              0x08, 0x07, // extended header cluster id
                              0x26, 0x00, // extended gbz command length
                              0x09, // frame control
                              0x00, // trans. seq number
    ...
    // TOM Command
    int8u tomGbzCmd[] = { 0x09, 0x01, // profile id
                             0x01, // component count
                            
                              // component #1 - ClearEventLog
                              // Clearing the GPF Esi's event log
                              0x00, // extended header control field
                              0x09, 0x07, // extended header cluster id
                              0x04, 0x00, // extended gbz command length
                              0x01, // frame control
                              0x00, // trans. seq number
                              0x01, // zcl command id
    ...
    // TOM Normal Response
    int8u tomGbzCmdResp[] = { 0x09, 0x01, // profile id
                                 0x01, // component count
    ...
    // Non-TOM Command
    int8u nonTomGbzCmd[] = { 0x09, 0x01, // profile id
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x03, // component count
                              ...
                              0x00, // tariff label
                              0x01, // number of price tiers in use
                              0x01, // number of block thresholds in use
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x01, // component count
                              ...
                              0x01, // extended header control field
                              0x02, 0x07, // extended header cluster id
                              0x0B, 0x00, // extended gbz command length
                              0x10, // frame control
                              0x00, // trans. seq number
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x01, // component count
                              ...
                              0x01, // extended header control field
                              0x02, 0x07, // extended header cluster id
                              0x13, 0x00, // extended gbz command length
                              0x10, // frame control
                              0x00, // trans. seq number
                              0x00, // ZCL command id - ReadAttributes
                              0x02, 0x03, // Attribute ID - Divisor
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x02, // component count
                              ...
                              0x00, // extended header control field
                              0x00, 0x07, // extended header cluster id
                              0x07, 0x00, // extended gbz command length
                              0x00, // frame control
                              0x00, // trans. seq number
                              0x00, // ZCL command id - ReadAttributes
                              ...
                              // component #2
                              0x01, // extended header control field
                              0x05, 0x07, // extended header cluster id
                              0x0F, 0x00, // extended gbz command length
                              0x00, // frame control
                              0x01, // trans. seq number
                              0x00, // ZCL command id - ReadAttributes
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x03, // component count
                              ...
                              0x09, 0x00, // extended gbz command length
                              0x00, // frame control
                              0x00, // trans. seq number
                              0x00, // ZCL command id - ReadAttributes
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x0B, // component count - 8-14
                              ...
                              0x01, // extended header control field
                              0x07, 0x07, // extended header cluster id
                              0x1C, 0x00, // extended gbz command length
                              0x09, // frame control
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x02, // component count
                              ...
                              0x00, // trans. seq number
                              0x00, // ZCL command id - GetEventLog
                              0x14, // Event Control / Log ID - GPF Security Log
                              0x00, 0x00, // Event id
                              0x00, 0x00, 0x00, 0x00, // Start Time
                              0xFF, 0xFF, 0xFF, 0xFF, // End Time
                              0x00, // Number of Events
                              ...
                              0x01, // trans. seq number
                              0x00, // ZCL command id - GetEventLog
                              0x17, // Event Control / Log ID - GSME Security Log
                              0x00, 0x00, // Event id
                              0x00, 0x00, 0x00, 0x00, // Start Time
                              0xFF, 0xFF, 0xFF, 0xFF, // End Time
                              0x00, // Number of Events
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x02, // component count - 8-14
                              ...
                              0x00, // extended header control field
                              0x00, 0x07, // extended header cluster id
                              0x14, 0x00, // extended gbz command length
                              0x09, // frame control
                              0x00, // trans. seq number
                              0x09, // ZCL command id
                              0x00, 0x00, 0x00, 0x00, // providerId
                              ...
                              0x01, // extended header control field
                              0x00, 0x07, // extended header cluster id
                              0x16, 0x00, // extended gbz command length
                              0x09, // frame control
                              0x01, // trans. seq number
                              0x01, // ZCL command id
                              0x00, 0x00, 0x00, 0x00, // provider id - 0x00
    ...
    //   = 507
    int8u i;
    int8u gbzCommand[507];
    int16u gbzCommandIndex = 0;

    emberAfCopyInt16u(gbzCommand, gbzCommandIndex, 0x0109);       // profile id
    gbzCommandIndex += 2;
    ...
    for (i=0; i<12; i++) {
      ...
      gbzCommandIndex += 1;
      emberAfCopyInt16u(gbzCommand, gbzCommandIndex, 0x0705);     // extended header cluster id
      gbzCommandIndex += 2;
      emberAfCopyInt16u(gbzCommand, gbzCommandIndex, 0x0010);     // extended gbz command length
      gbzCommandIndex += 2;
    ...
    for (i=0; i<12; i++) {
      ...
      gbzCommandIndex += 1;
      emberAfCopyInt16u(gbzCommand, gbzCommandIndex, 0x0702);     // extended header cluster id
      gbzCommandIndex += 2;
      emberAfCopyInt16u(gbzCommand, gbzCommandIndex, 0x0010);     // extended gbz command length
      gbzCommandIndex += 2;
      emberAfCopyInt8u(gbzCommand, gbzCommandIndex, 0x01);        // frame control
    ...
    // Command
    // Command Length
    //   = 2:profileId + 1:componentCount + (12*21):GetSnapshot
    //   = 255
    int8u i;
    int8u gbzCommand[255];
    int16u gbzCommandIndex = 0;

    emberAfCopyInt16u(gbzCommand, gbzCommandIndex, 0x0109);       // profile id
    gbzCommandIndex += 2;
    emberAfCopyInt8u(gbzCommand, gbzCommandIndex, 0x0C);          // component count
    gbzCommandIndex += 1;
    for (i=0; i<12; i++) {
      if (i==11) {
        emberAfCopyInt8u(gbzCommand, gbzCommandIndex, 0x01);      // extended header control field
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             0x01, // component count
                              ...
                              0x11, // extended header control field
                              0x05, 0x07, // extended header cluster id
                              0x08, 0x00, // extended gbz command length
                              0x00, 0x00, 0x00, 0x00, // extended header from date (TODO)
                              0x01, // frame control
                              0x00, // trans. seq number
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             ...
                             0x00, // extended header control field
                             0x00, 0x07, // extended header cluster id
                             0x27, 0x00, // extended gbz command length
                             0x00, // frame control
                             0x00, // trans. seq number
                             0x00, // ZCL command id - ReadAttributes
    ...
    int8u gbzCommand[] = { 0x09, 0x01, // profile id
                             ...
                             0x00, 0x00, // Attribute ID - Prepayment Information: Payment Control Configuration
