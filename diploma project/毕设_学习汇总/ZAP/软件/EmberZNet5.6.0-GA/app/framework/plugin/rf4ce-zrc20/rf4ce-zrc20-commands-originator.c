...
static boolean addOrUpdateActionRecord(int8u pairingIndex,
                                       EmberAfRf4ceZrcActionBank actionBank,
                                       EmberAfRf4ceZrcActionCode actionCode,
                                       EmberAfRf4ceZrcModifierBit actionModifiers,
                                       int16u actionVendorId,
                                       const int8u *actionData,
                                       int8u actionDataLength,
                                       boolean atomic);
static EmberStatus sendActionsCommand(int8u pairingIndex);
static EmberStatus sendZrc11UserControlCommand(int8u recordIndex);
static boolean checkActionsCommandSize(int8u pairingIndex);
static void updateRecordAfterSend(int8u recordIndex);
static void rescheduleOutgoingEvent(void);
static EmberStatus getActionsCommandTxOptions(int8u pairingIndex,
...
EmberStatus emberAfRf4ceZrc20ActionStart(int8u pairingIndex,
                                         EmberAfRf4ceZrcActionBank actionBank,
                                         EmberAfRf4ceZrcActionCode actionCode,
                                         EmberAfRf4ceZrcModifierBit actionModifiers,
                                         int16u actionVendorId,
                                         ...
                                         boolean atomic)
{
  int8u version = emAfRf4ceZrc20GetPeerZrcVersion(pairingIndex);
...
EmberStatus emberAfRf4ceZrc20ActionStop(int8u pairingIndex,
                                        EmberAfRf4ceZrcActionBank actionBank,
                                        EmberAfRf4ceZrcActionCode actionCode,
                                        EmberAfRf4ceZrcModifierBit actionModifiers,
                                        int16u actionVendorId)
...
static void outgoingEventHandler(void)
{
  int16u nowMs = halCommonGetInt16uMillisecondTick();
  int8u pairingIndex = 0xFF;
  int8u recordIndex;
...
static boolean addOrUpdateActionRecord(int8u pairingIndex,
                                       ...
                                       boolean atomic)
{
  int8u entryIndex = 0xFF;
  int8u freeEntryIndex = 0xFF;
  int16u nowMs = halCommonGetInt16uMillisecondTick();
  int8u zrcVersion = emAfRf4ceZrc20GetPeerZrcVersion(pairingIndex);
  int8u i;
...
// index.
static int8u getActionRecordLength(int8u recordIndex)
{
...
static int8u addActionRecordToActionsCommand(int8u recordIndex, int8u *ptr)
{
...
{
  EmberStatus status;
  int8u buffer[EMBER_AF_RF4CE_MAXIMUM_RF4CE_PAYLOAD_LENGTH];
...
static EmberStatus sendZrc11UserControlCommand(int8u recordIndex)
{
  int8u buffer[ZRC11_MAX_USER_CONTROL_COMMAND_LENGTH];
  int8u bufferLength = 2; // frame control (1) + RC command code (1)
...
{
  int16u nowMs = halCommonGetInt16uMillisecondTick();
  int16u delayMs = MAX_INT16U_VALUE;
  int8u i;
