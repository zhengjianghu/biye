...
typedef struct {
  ...
  int8u size;
  int8u bitmask;
  int16u dimension;  // only for arrayed attributes
...
typedef struct {
  int16u gdpVersion;
  int32u gdpCapabilities;
  int8u powerStatus;
  int8u pollConstraints[APL_GDP_POLL_CONSTRAINTS_SIZE];
  int8u pollConfiguration[APL_GDP_POLL_CONFIGURATION_SIZE];
  int16u autoCheckValidationPeriod;
  int16u linkLostWaitTime;
  int8u identificationCapabilities;

  // Test arrayed attributes
#if defined(EMBER_SCRIPTED_TEST)
  int16u settableScalarTest1;
  int16u settableScalarTest2;
  int16u oneDimensionalTestAttribute[GDP_ATTRIBUTE_ONE_DIMENSIONAL_ARRAY_TEST_DIMENSION];
  int32u twoDimensionalTestAttribute[GDP_ATTRIBUTE_TWO_DIMENSIONAL_ARRAY_TEST_FIRST_DIMENSION][GDP_ATTRIBUTE_TWO_DIMENSIONAL_ARRAY_TEST_SECOND_DIMENSION];
#endif
