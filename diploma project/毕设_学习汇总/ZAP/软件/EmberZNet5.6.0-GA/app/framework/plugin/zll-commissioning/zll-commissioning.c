...
#ifdef EMBER_AF_PLUGIN_ZLL_COMMISSIONING_LINK_INITIATOR
int16u emAfZllIdentifyDurationS = EMBER_AF_PLUGIN_ZLL_COMMISSIONING_IDENTIFY_DURATION;
#endif
                                                        ...
                                                        int8u *message)
{
  ...
  case ZCL_IDENTIFY_REQUEST_COMMAND_ID:
    if (msgIndex + 2 <= msgLen) {
      int16u identifyDurationS = emberAfGetInt16u(message, msgIndex, msgLen);
