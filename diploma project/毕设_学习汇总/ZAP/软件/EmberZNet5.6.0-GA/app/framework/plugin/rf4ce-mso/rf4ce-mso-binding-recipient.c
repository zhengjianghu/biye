...
static boolean isValidDiscoveryOrPairRequest(int8u nodeCapabilities,
                                             const EmberRf4ceVendorInfo *vendorInfo,
                                             const EmberRf4ceApplicationInfo *appInfo,
                                             int8u searchDevType);
static void restoreOrRemove(int8u pairingIndex);
static void sync(boolean up);
...
// originator.
static int8u originatorPairingIndex = NULL_PAIRING_INDEX;
