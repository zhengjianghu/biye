...
extern const int8u emAfRf4ceGdpApplicationSpecificUserString[USER_STRING_APPLICATION_SPECIFIC_USER_STRING_LENGTH];
...
extern const int8u emAfGdp1xProfiles[];
extern const int8u emAfGdp20Profiles[];
...
EmberStatus emAfRf4ceGdpInitiateKeyExchangeInternal(int8u pairingIndex,
                                                    boolean intCall);
...
extern int8u emAfTemporaryPairingIndex;
extern int8u emAfCurrentProfileSpecificIndex;
extern int16u emAfGdpState;
extern int32u emberAfPluginRf4ceGdpCapabilities;
...
typedef struct {
  EmberEUI64 ieeeAddr;
  EmberPanId panId;
  int8u supportedProfiles[EMBER_RF4CE_APPLICATION_PROFILE_ID_LIST_MAX_LENGTH];
  int8u supportedProfilesLength;
  int8u channel;
  int8u primaryClassDescriptor;
  int8u secondaryClassDescriptor;
  int8u tertiaryClassDescriptor;
  int8u rxLqi;
  int8u info;
...
typedef struct {
  int8u localConfigurationStatus;
  int8u candidateIndex;
} EmAfBindingInfo;
...
void emAfRf4ceGdpGetPairingKey(int8u pairingIndex, EmberKeyData *key);
void emAfRf4ceGdpSetPairingKey(int8u pairingIndex, EmberKeyData *key);
...
void emAfRf4ceGdpSecurityValidationCompleteCallback(int8u pairingIndex);
...
void emAfRf4ceGdpIncomingKeyExchangeConfirm(boolean secured);
...
boolean emAfRf4ceGdpHasAttributeRecord(void);
...
extern int8u emAfRf4ceGdpOutgoingCommandFrameControl;
