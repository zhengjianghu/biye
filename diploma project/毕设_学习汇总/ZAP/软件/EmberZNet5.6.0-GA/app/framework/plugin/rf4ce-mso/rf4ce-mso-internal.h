...
typedef struct {
  ...
  int8u basicLqiThreshold;
  int8u strictLqiThreshold;
  int8u rxLqi;
  int8u control;
} EmAfMsoPairingCanditate;

extern int8u emAfRf4ceMsoBuffer[];
extern int8u emAfRf4ceMsoBufferLength;
...
void emAfRf4ceMsoSetValidation(int8u pairingIndex,
...
EmberAfRf4ceMsoValidationState emAfRf4ceMsoGetValidationState(int8u pairingIndex);
EmberAfRf4ceMsoCheckValidationStatus emAfRf4ceMsoGetValidationStatus(int8u pairingIndex);
