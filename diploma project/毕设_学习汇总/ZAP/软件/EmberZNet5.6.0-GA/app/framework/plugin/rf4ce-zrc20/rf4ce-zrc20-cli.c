...
void emberAfPluginRf4ceZrc20StartCommand(void)
{
  ...
  int16u actionVendorId = (int16u)emberUnsignedCommandArgument(4);
  int8u actionDataLength;
  int8u *actionData = emberStringCommandArgument(5, &actionDataLength);
  boolean atomic = (boolean)emberUnsignedCommandArgument(6);
