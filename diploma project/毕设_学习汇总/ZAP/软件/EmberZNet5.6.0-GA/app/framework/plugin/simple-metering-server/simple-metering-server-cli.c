...
void emAfPluginSimpleMeteringServerCliConfigureMirror(void)
{
  ...
  int32u reportingInterval = (int32u)emberUnsignedCommandArgument(4);
  int8u mirrorNotificationReporting = (int8u)emberUnsignedCommandArgument(5);
  int8u notificationScheme = (int8u)emberUnsignedCommandArgument(6);
...
{
  int8u toggleFastPolling = (int8u)emberUnsignedCommandArgument(0);
