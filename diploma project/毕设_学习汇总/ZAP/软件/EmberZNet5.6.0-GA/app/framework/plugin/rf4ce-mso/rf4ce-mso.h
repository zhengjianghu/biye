 ...
 * command.
 */
EmberStatus emberAfRf4ceMsoUserControlPress(int8u pairingIndex,
                                            EmberAfRf4ceMsoKeyCode rcCommandCode,
                                            const int8u *rcCommandPayload,
 ...
 * command.
 */
EmberStatus emberAfRf4ceMsoUserControlRelease(int8u pairingIndex,
                                              EmberAfRf4ceMsoKeyCode rcCommandCode);
 ...
 * command.
 */
EmberStatus emberAfRf4ceMsoSetAttributeRequest(int8u pairingIndex,
 ...
 * command.
 */
EmberStatus emberAfRf4ceMsoGetAttributeRequest(int8u pairingIndex,
                                               EmberAfRf4ceMsoAttributeId attributeId,
                                               int8u index,
                                               int8u valueLen);
   ...
   * otherwise.
   */
  boolean emberAfRf4ceMsoIrRfDatabaseEntryUseDefault(const EmberAfRf4ceMsoIrRfDatabaseEntry *entry);
#else
   ...
   */
  boolean emberAfRf4ceMsoIrRfDatabaseEntryHasRfPressedDescriptor(const EmberAfRf4ceMsoIrRfDatabaseEntry *entry);
#else
   ...
   * descriptor or FALSE otherwise.
   */
  boolean emberAfRf4ceMsoIrRfDatabaseEntryHasRfRepeatedDescriptor(const EmberAfRf4ceMsoIrRfDatabaseEntry *entry);
#else
   ...
   * descriptor or FALSE otherwise.
   */
  boolean emberAfRf4ceMsoIrRfDatabaseEntryHasRfReleasedDescriptor(const EmberAfRf4ceMsoIrRfDatabaseEntry *entry);
#else
   ...
   */
  int8u emberAfRf4ceMsoIrRfDatabaseEntryGetMinimumNumberOfTransmissions(const EmberAfRf4ceMsoIrRfDatabaseRfDescriptor *rfDescriptor);
#else
   ...
   */
  boolean emberAfRf4ceMsoIrRfDatabaseEntryShouldTransmitUntilRelease(const EmberAfRf4ceMsoIrRfDatabaseRfDescriptor *rfDescriptor);
#else
   ...
   * FALSE otherwise.
   */
  boolean emberAfRf4ceMsoIrRfDatabaseEntryHasIrDescriptor(const EmberAfRf4ceMsoIrRfDatabaseEntry *entry);
#else
