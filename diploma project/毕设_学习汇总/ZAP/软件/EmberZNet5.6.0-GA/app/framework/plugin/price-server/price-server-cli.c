...
void emAfPriceServerCliAck(void)
{
  ...
  if ( ((int8u)emberUnsignedCommandArgument(0)) == 1) {
...
void emAfPriceServerCliBlockPeriodAdd(void){
  emberAfPluginPriceServerBlockPeriodAdd( (int8u) emberUnsignedCommandArgument(0),
                                          (int32u)emberUnsignedCommandArgument(1),
                                          (int32u)emberUnsignedCommandArgument(2),
                                          (int32u)emberUnsignedCommandArgument(3),
                                          (int32u)emberUnsignedCommandArgument(4),
                                          (int8u) emberUnsignedCommandArgument(5),
                                          (int8u) emberUnsignedCommandArgument(6),
                                          (int32u)emberUnsignedCommandArgument(7),
                                          (int32u)emberUnsignedCommandArgument(8),
                                          (int8u) emberUnsignedCommandArgument(9),
                                          (int8u)emberUnsignedCommandArgument(10) );
}

// plugin price-server block-period print <endpoint:1> <index:1>
void emAfPriceServerCliBlockPeriodPrint(void){
  emberAfPluginPriceServerBlockPeriodPrint( (int8u)emberUnsignedCommandArgument(0),
                                            (int8u)emberUnsignedCommandArgument(1) );
}

// plugin price-server block-period pub <nodeId:2> <srcEndpoint:1> <dstEndpoint:1> <index:1>
void emAfPriceServerCliBlockPeriodPub(void){
  emberAfPluginPriceServerBlockPeriodPub( (int16u)emberUnsignedCommandArgument(0),
                                          (int8u)emberUnsignedCommandArgument(1),
                                          (int8u)emberUnsignedCommandArgument(2),
                                          (int8u)emberUnsignedCommandArgument(3) );
}
...
void emAfPriceServerCliBlockPeriodClear(void){
  emberAfPriceClearBlockPeriodTable((int8u)emberUnsignedCommandArgument(0));
}
...
{
  emberAfPluginPriceServerConversionFactorAdd((int8u) emberUnsignedCommandArgument(0),
                                              (int32u)emberUnsignedCommandArgument(1),
                                              (int32u)emberUnsignedCommandArgument(2),
                                              (int32u)emberUnsignedCommandArgument(3),
                                              (int8u) emberUnsignedCommandArgument(4) );
}

// plugin price-server conversion-factor clear <endpoint:1>
void emAfPriceServerCliConversionFactorClear(void)
{
  emberAfPluginPriceServerConversionFactorClear( (int8u)emberUnsignedCommandArgument(0) );
}
...
{
  int8u tableIndex = (int8u)emberUnsignedCommandArgument(0);
...
{
  emberAfPrintConversionTable( (int8u)emberUnsignedCommandArgument(0) );
}
...
{
  emberAfPluginPriceServerCalorificValueAdd((int8u) emberUnsignedCommandArgument(0),
                                            (int32u)emberUnsignedCommandArgument(1),
                                            (int32u)emberUnsignedCommandArgument(2),
                                            (int32u)emberUnsignedCommandArgument(3),
                                            (int8u) emberUnsignedCommandArgument(4),
...
{
  emberAfPluginPriceServerCalorificValueClear( (int8u)emberUnsignedCommandArgument(0) );
}

// plugin price-server calorific-factor print <endpoint:1>
void emAfPriceServerCliCalorificValuePrint(void)
{
  emberAfPrintCalorificValuesTable( (int8u)emberUnsignedCommandArgument(0) );
}
...
{
  emberAfPluginPriceServerCo2ValueAdd((int8u) emberUnsignedCommandArgument(0),
                                      (int32u)emberUnsignedCommandArgument(1),
                                      (int32u)emberUnsignedCommandArgument(2),
                                      (int32u)emberUnsignedCommandArgument(3),
                                      (int8u) emberUnsignedCommandArgument(4),
                                      (int32u)emberUnsignedCommandArgument(5),
                                      (int8u) emberUnsignedCommandArgument(6),
                                      (int8u) emberUnsignedCommandArgument(7));
}

// plugin price-server co2-val clear <endpoint:1>
void emAfPriceServerCliCo2ValueClear(void)
{
  emberAfPluginPriceServerCo2ValueClear( (int8u)emberUnsignedCommandArgument(0) );
}

// plugin price-server co2-val print <endpoint:1>
void emAfPriceServerCliCo2ValuePrint(void)
{
  emberAfPrintCo2ValuesTable( (int8u)emberUnsignedCommandArgument(0) );
}
...
void emAfPriceServerCliTierLabelSet(void) 
{
  ...
  tierLabel[0] = len;
  emberAfPluginPriceServerTierLabelSet((int8u) emberUnsignedCommandArgument(0),
                                       (int8u) emberUnsignedCommandArgument(1),
                                       (int8u) emberUnsignedCommandArgument(2),
                                       (int32u)emberUnsignedCommandArgument(3),
                                       (int32u)emberUnsignedCommandArgument(4),
...
void emAfPriceServerCliTierLabelAddLabel(void){
  ...
  tariffId = (int32u)emberUnsignedCommandArgument(1);
  emberAfPluginPriceServerTierLabelAddLabel( (int8u)emberUnsignedCommandArgument(0),
                                       tariffId,
                                       (int8u)emberUnsignedCommandArgument(2),
                                       tierLabel);
}
...
{
  emberAfPrintTierLabelsTable( (int8u)emberUnsignedCommandArgument(0) );
}
...
{
  emberAfPluginPriceServerTierLabelPub((int16u)emberUnsignedCommandArgument(0),
                                       (int8u)emberUnsignedCommandArgument(1),
                                       (int8u)emberUnsignedCommandArgument(2),
                                       (int8u)emberUnsignedCommandArgument(3));
...
{
  emberAfPluginPriceServerCo2LabelPub((int16u)emberUnsignedCommandArgument(0),
                                       (int8u)emberUnsignedCommandArgument(1),
                                       (int8u)emberUnsignedCommandArgument(2),
                                       (int8u)emberUnsignedCommandArgument(3));
}
...
{
  emberAfPluginPriceServerBillingPeriodAdd((int8u) emberUnsignedCommandArgument(0),
                                           (int32u)emberUnsignedCommandArgument(1),
                                           (int32u)emberUnsignedCommandArgument(2),
                                           (int32u)emberUnsignedCommandArgument(3),
                                           (int32u)emberUnsignedCommandArgument(4),
...
{
  emberAfPrintBillingPeriodTable( (int8u) emberUnsignedCommandArgument(0) );
}

// plugin price-server billing-period pub
void emAfPriceServerCliBillingPeriodPub(void)
{
  emberAfPluginPriceServerBillingPeriodPub((int16u)emberUnsignedCommandArgument(0),
                                       (int8u)emberUnsignedCommandArgument(1),
                                       (int8u)emberUnsignedCommandArgument(2),
                                       (int8u)emberUnsignedCommandArgument(3));
}
...
{
  emberAfPluginPriceServerConsolidatedBillAdd((int8u) emberUnsignedCommandArgument(0),
                                              (int32u)emberUnsignedCommandArgument(1),
                                              (int32u)emberUnsignedCommandArgument(2),
                                              (int32u)emberUnsignedCommandArgument(3),
                                              (int32u)emberUnsignedCommandArgument(4),
                                              ...
                                              (int8u) emberUnsignedCommandArgument(6),
                                              (int32u)emberUnsignedCommandArgument(7),
                                              (int16u)emberUnsignedCommandArgument(8),
                                              (int8u) emberUnsignedCommandArgument(9) );
}
...
{
  emberAfPrintConsolidatedBillTableEntry( (int8u)emberUnsignedCommandArgument(0),
                                          (int8u)emberUnsignedCommandArgument(1) );
}
...
{
  emberAfPluginPriceServerConsolidatedBillPub( (int16u)emberUnsignedCommandArgument(0),
                                               (int8u)emberUnsignedCommandArgument(1),
                                               (int8u)emberUnsignedCommandArgument(2),
                                               (int8u)emberUnsignedCommandArgument(3) );
}
...
void emAfPriceServerCliCppEventSet(void){
  emberAfPluginPriceServerCppEventSet( (int8u) emberUnsignedCommandArgument(0),
                                       (int8u) emberUnsignedCommandArgument(1),
                                       (int32u)emberUnsignedCommandArgument(2),
                                       (int32u)emberUnsignedCommandArgument(3),
                                       (int32u)emberUnsignedCommandArgument(4),
                                       (int16u)emberUnsignedCommandArgument(5),
                                       (int8u) emberUnsignedCommandArgument(6),
                                       (int8u) emberUnsignedCommandArgument(7),
                                       (int8u) emberUnsignedCommandArgument(8));
}


// plugin price-server cpp-event pub <nodeId:2> <srcEndpoint:1> <dstEndpoint:1>
void emAfPriceServerCliCppEventPub(void){
  emberAfPluginPriceServerCppEventPub( (int16u)emberUnsignedCommandArgument(0),
                                       (int8u )emberUnsignedCommandArgument(1),
                                       (int8u )emberUnsignedCommandArgument(2) );
}
...
void emAfPriceServerCliCppEventPrint(void){
  emberAfPluginPriceServerCppEventPrint( (int8u)emberUnsignedCommandArgument(0) );
}

// plugin price-server credit-pmt pub <nodeId:2> <srcEndpoint:1> <dstEndpoint:1> <index:1>
void emAfPriceServerCliCreditPaymentPub(void){
  emberAfPluginPriceServerCreditPaymentPub( (int16u)emberUnsignedCommandArgument(0),
                                            (int8u )emberUnsignedCommandArgument(1),
                                            (int8u )emberUnsignedCommandArgument(2),
                                            (int8u )emberUnsignedCommandArgument(3) );
}
...
void emAfPriceServerCliCreditPaymentSet(void){
  int8u len;
  int8u creditPaymentRef[21];
  len = emberCopyStringArgument(10, creditPaymentRef+1,20,FALSE);
  creditPaymentRef[0] = len;
  emberAfPluginPriceServerCreditPaymentSet( (int8u) emberUnsignedCommandArgument(0),
                                            (int8u) emberUnsignedCommandArgument(1),
                                            (int8u) emberUnsignedCommandArgument(2),
                                            (int32u)emberUnsignedCommandArgument(3),
                                            (int32u)emberUnsignedCommandArgument(4),
                                            (int32u)emberUnsignedCommandArgument(5),
                                            (int32u)emberUnsignedCommandArgument(6),
                                            (int8u) emberUnsignedCommandArgument(7),
                                            (int32u)emberUnsignedCommandArgument(8),
                                            (int32u)emberUnsignedCommandArgument(9),
                                            creditPaymentRef );
}

// plugin price-server currency-conv pub <nodeId:2> <srcEndpoint:1> <dstEndpoint:1>
void emAfPriceServerCliCurrencyConversionPub(void){
  emberAfPluginPriceServerCurrencyConversionPub( (int16u)emberUnsignedCommandArgument(0),
                                                 (int8u)emberUnsignedCommandArgument(1),
                                                 (int8u)emberUnsignedCommandArgument(2) );
}
...
void emAfPriceServerCliCurrencyConversionSet(void){
  emberAfPluginPriceServerCurrencyConversionSet( (int8u) emberUnsignedCommandArgument(0),
                                                 (int8u) emberUnsignedCommandArgument(1),
                                                 (int32u)emberUnsignedCommandArgument(2),
                                                 (int32u)emberUnsignedCommandArgument(3),
                                                 (int32u)emberUnsignedCommandArgument(4),
                                                 (int16u)emberUnsignedCommandArgument(5),
                                                 (int16u)emberUnsignedCommandArgument(6),
                                                 (int32u)emberUnsignedCommandArgument(7),
                                                 (int8u) emberUnsignedCommandArgument(8),
                                                 (int32u)emberUnsignedCommandArgument(9) );
...
void emAfPriceServerCliTariffCancellationSet(void){
  emberAfPluginPriceServerTariffCancellationSet( (int8u) emberUnsignedCommandArgument(0),
                                                 (int8u) emberUnsignedCommandArgument(1),
                                                 (int32u)emberUnsignedCommandArgument(2),
                                                 (int32u)emberUnsignedCommandArgument(3),
                                                 (int8u) emberUnsignedCommandArgument(4) );
...
void emAfPriceServerCliTariffCancellationPub(void){
  emberAfPluginPriceServerTariffCancellationPub( (int16u)emberUnsignedCommandArgument(0),
                                                 (int8u)emberUnsignedCommandArgument(1),
                                                 (int8u)emberUnsignedCommandArgument(2) );
}
