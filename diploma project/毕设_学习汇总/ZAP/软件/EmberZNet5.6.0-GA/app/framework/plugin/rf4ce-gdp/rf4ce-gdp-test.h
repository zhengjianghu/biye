...
void emberAfPluginRf4ceGdpKeyExchangeCompleteCallback(int8u pairingIndex);
...
boolean emberAfPluginRf4ceGdpIncomingBindProxyCallback(const EmberEUI64 sourceIeeeAddr);

boolean emberAfPluginRf4ceGdpVendorSpecificKeyExchangeCallback(int8u initiatorVendorSpecificParam,
                                                               int8u *responderVendorSpecificParam,
                                                               int8u* sharedSecret);

void emberAfPluginRf4ceGdpHeartbeatPollingEstablishedCallback(int8u pairingIndex,
