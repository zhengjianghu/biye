...
extern void emAfRf4ceGdpPollingNotifyBindingComplete(int8u pairingIndex);

extern void emAfRf4ceGdpPollingIncomingCommandCallback(boolean framePending);

extern void emAfRf4ceGdpGetPollConfigurationAttribute(int8u pairingIndex,
                                                      int8u *pollConfiguration);

extern void emAfRf4ceGdpSetPollConfigurationAttribute(int8u pairingIndex,
