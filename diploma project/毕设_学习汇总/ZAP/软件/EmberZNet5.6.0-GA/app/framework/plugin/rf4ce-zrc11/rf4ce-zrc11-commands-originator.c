...
typedef struct {
  ...
  int8u rcCommandPayload[EMBER_AF_PLUGIN_RF4CE_ZRC11_MAXIMUM_RC_COMMAND_PAYLOAD_LENGTH];
...
EmberStatus emberAfRf4ceZrc11UserControlPress(int8u pairingIndex,
                                              EmberAfRf4ceUserControlCode rcCommandCode,
...
EmberStatus emberAfRf4ceZrc11UserControlRelease(int8u pairingIndex,
                                                EmberAfRf4ceUserControlCode rcCommandCode)
{
