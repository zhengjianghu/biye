...
{
    /* Catch if index is out of range or table is full. */
    assert (emAfRf4ceZrc20ActionMappingClientSetActionMapping(pairingIndex,
                                                              entryIndex,
                                                              actionMapping)
            == EMBER_SUCCESS);
}
...
static int8u actionMappingsClientHeap[EMBER_AF_PLUGIN_RF4CE_ZRC20_ACTION_MAPPING_CLIENT_ACTION_MAPPING_HEAP_SIZE];
static int8u *tail = actionMappingsClientHeap;

static void removeOldEntry(int8u pairingIndex, int16u index);
...
EmberStatus emberAfRf4ceZrc20ActionMappingClientClearActionMappingsPerPairing(int8u pairingIndex)
{
  int16u i;
...
EmberStatus emberAfRf4ceZrc20ActionMappingClientClearActionMapping(int8u pairingIndex,
...
EmberStatus emberAfRf4ceZrc20ActionMappingClientGetActionMapping(int8u pairingIndex,
                                                                 EmberAfRf4ceDeviceType actionDeviceType,
                                                                 EmberAfRf4ceZrcActionBank actionBank,
                                                                 EmberAfRf4ceZrcActionCode actionCode,
                                                                 EmberAfRf4ceZrcActionMapping* actionMapping)
{
  ...
  for (i = 0; i < EMBER_AF_RF4CE_ZRC_MAPPABLE_ACTION_COUNT; i++) {
    if ((mappableActionsClientTable[i].actionDeviceType == actionDeviceType)
      ...
      MEMCOPY((int8u*) actionMapping,
              (int8u*) &actionMappingsClientTable[pairingIndex][i],
...
EmberStatus emberAfRf4ceZrc20ActionMappingClientSetActionMapping(int8u pairingIndex,
                                                                 EmberAfRf4ceDeviceType actionDeviceType,
                                                                 EmberAfRf4ceZrcActionBank actionBank,
                                                                 EmberAfRf4ceZrcActionCode actionCode,
                                                                 EmberAfRf4ceZrcActionMapping* actionMapping)
...
EmberStatus emAfRf4ceZrc20ActionMappingClientClearActionMapping(int8u pairingIndex,
                                                                int16u entryIndex)
{
  // Pairing index out of range.
  if (pairingIndex >= EMBER_RF4CE_PAIRING_TABLE_SIZE) {
...
EmberStatus emAfRf4ceZrc20ActionMappingClientSetActionMapping(int8u pairingIndex,
                                                              int16u entryIndex,
                                                              EmberAfRf4ceZrcActionMapping* actionMapping)
{
  // Pairing index out of range.
...
int16u emAfPluginRf4ceZrc20ActionMappingClientGetMappableActionCount(void)
{
    return EMBER_AF_RF4CE_ZRC_MAPPABLE_ACTION_COUNT;
}

EmberStatus emAfPluginRf4ceZrc20ActionMappingClientGetMappableAction(int16u entryIndex,
                                                                     EmberAfRf4ceZrcMappableAction* mappableAction)
{
    /* Index out of range. */
    if (entryIndex >= EMBER_AF_RF4CE_ZRC_MAPPABLE_ACTION_COUNT)
    ...
    MEMCOPY((int8u*)mappableAction,
            (int8u*)&mappableActionsClientTable[entryIndex],
