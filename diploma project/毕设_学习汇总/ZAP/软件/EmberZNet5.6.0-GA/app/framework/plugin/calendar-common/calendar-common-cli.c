...
int8u calendarName0[EMBER_AF_PLUGIN_CALENDAR_MAX_CALENDAR_NAME_LENGTH + 1] =
  {0x0C, 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l'};
int8u calendarName1[EMBER_AF_PLUGIN_CALENDAR_MAX_CALENDAR_NAME_LENGTH + 1] = 
...
// the days apart.
static void setupTestScheduleEntries(EmberAfCalendarDayStruct* day, int8u offset)
{
  int8u i;
  for (i = 0; i < day->numberOfScheduleEntries; i++) {
...
static void setupTestDays(EmberAfCalendarStruct* calendar, int8u offset)
{
  int8u i;
...
static void setupTestWeeks(EmberAfCalendarStruct* calendar, int8u offset)
{
  int8u i;
...
static void setupTestSeasons(EmberAfCalendarStruct* calendar, int8u offset)
{
  int8u i; 
...
void emberAfPluginCalendarCommonLoadSimpleCalendarCommand(void)
{
  ...
  if (index < EMBER_AF_PLUGIN_CALENDAR_COMMON_TOTAL_CALENDARS) {
    calendars[index].providerId = (int32u)emberUnsignedCommandArgument(1);
    calendars[index].issuerEventId = (int32u)emberUnsignedCommandArgument(2);
    calendars[index].calendarId = (int32u)emberUnsignedCommandArgument(3);
    calendars[index].startTimeUtc = (int32u)emberUnsignedCommandArgument(4);
    if (calendars[index].startTimeUtc == 0) {
      calendars[index].startTimeUtc = emberAfGetCurrentTime();
    }
    calendars[index].calendarType = (int8u)emberUnsignedCommandArgument(5);
...
{
  int8u calName[EMBER_AF_PLUGIN_CALENDAR_MAX_CALENDAR_NAME_LENGTH +1];
  int8u length = emberCopyStringArgument(6,
                                         calName + 1,
                                         EMBER_AF_PLUGIN_CALENDAR_MAX_CALENDAR_NAME_LENGTH,
                                         FALSE);
  calName[0] = length;
  emberAfCalendarCommonSetCalInfo((int8u)emberUnsignedCommandArgument(0),
...
{
  int8u calName[EMBER_AF_PLUGIN_CALENDAR_MAX_CALENDAR_NAME_LENGTH +1];
  int8u length = emberCopyStringArgument(5,
                                         calName + 1,
                                         EMBER_AF_PLUGIN_CALENDAR_MAX_CALENDAR_NAME_LENGTH,
                                         FALSE);
  calName[0] = length;
  emberAfCalendarCommonAddCalInfo((int32u)emberUnsignedCommandArgument(0),
                                  (int32u)emberUnsignedCommandArgument(1),
                                  (int32u)emberUnsignedCommandArgument(2),
                                  (int32u)emberUnsignedCommandArgument(3),
...
{
  emberAfCalendarCommonSetDayProfInfo((int8u)emberUnsignedCommandArgument(0),
                                      (int8u)emberUnsignedCommandArgument(1),
                                      (int8u)emberUnsignedCommandArgument(2),
                                      (int16u)emberUnsignedCommandArgument(3),
                                      (int8u)emberUnsignedCommandArgument(4));
}
...
{
  emberAfCalendarServerSetWeekProfInfo((int8u)emberUnsignedCommandArgument(0),
                                       (int8u)emberUnsignedCommandArgument(1),
                                       (int8u)emberUnsignedCommandArgument(2),
...
void emberAfCalendarCommonCliSetSeasonsInfo(void)
{
  ...
  emberAfCalendarServerSetSeasonsInfo((int8u)emberUnsignedCommandArgument(0),
                                      (int8u)emberUnsignedCommandArgument(1),
                                      date,
                                      (int8u)emberUnsignedCommandArgument(3));
}
