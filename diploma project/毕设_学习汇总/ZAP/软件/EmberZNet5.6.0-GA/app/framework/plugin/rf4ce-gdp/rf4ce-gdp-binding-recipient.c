...
static boolean savedDiscoveryRequestValidOrPairCompletePending = FALSE;
...
#ifdef EMBER_AF_PLUGIN_RF4CE_GDP_IS_RECIPIENT
static boolean handleGdp20BasedDiscoveryRequest(const EmberEUI64 srcIeeeAddr,
...
// TODO:
static boolean handleGdp1xBasedDiscoveryRequest(void);

static boolean handleNonGdpBasedDiscoveryRequest(const int8u *profileIdList,
...
static void finishBindingProcedure(boolean success);

static void syncLocalPairingTable(void);

static int8u getLocalPrimaryClassNumber(void);
#endif
...
boolean emberAfPluginRf4ceProfileGdpDiscoveryRequestCallback(const EmberEUI64 srcIeeeAddr,
                                                             int8u nodeCapabilities,
                                                             const EmberRf4ceVendorInfo *vendorInfo,
                                                             const EmberRf4ceApplicationInfo *appInfo,
                                                             int8u searchDevType,
                                                             int8u rxLinkQuality)
{
  ...
  matchingProfileIdListLength =
      emAfCheckDeviceTypeAndProfileIdMatch(searchDevType,
                                           ...
                                           (int8u*)emAfRf4ceApplicationInfo.profileIdList,
                                                        ...
                                                        int8u keyExchangeTransferCount)
{
  ...
  boolean bindingProxySupported = ((gdpVersion == GDP_VERSION_2_0)
...
boolean emAfRf4ceGdpIncomingPushAttributesRecipientCallback(void)
{
...
boolean emAfRf4ceGdpIncomingGetAttributesRecipientCallback(void)
{
...
boolean emAfRf4ceGdpIncomingPullAttributesRecipientCallback(void)
{
  EmberAfRf4ceGdpAttributeIdentificationRecord tempIdRecord;
...
static boolean discoveryRequestDataCompare(EmAfDiscoveryOrPairRequestData *discData)
{
