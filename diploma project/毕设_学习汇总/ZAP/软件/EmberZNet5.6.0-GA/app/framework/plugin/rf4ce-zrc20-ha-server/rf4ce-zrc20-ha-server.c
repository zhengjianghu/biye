...
static int8u aplHaAttributesStatusTable[EMBER_RF4CE_PAIRING_TABLE_SIZE][ZRC_HA_SERVER_NUM_OF_HA_INSTANCES][ZRC_HA_ATTRIBUTE_STATUS_TABLE_SIZE/8+1];
static int8u aplHaAttributesValueTable[EMBER_RF4CE_PAIRING_TABLE_SIZE][ZRC_HA_SERVER_NUM_OF_HA_INSTANCES][ZRC_HA_ATTRIBUTE_TABLE_SIZE];


static EmberStatus ConvertHaActionToZclCommand(EmberAfRf4ceZrcActionCode actionCode,
                                               const int8u* actionPayload,
                                               int8u actionPayloadLength);
...
EmberAfRf4ceGdpAttributeStatus emberAfPluginRf4ceZrc20HaServerGetHaAttribute(int8u pairingIndex,
                                                                             int8u haInstanceId,
                                                                             int8u haAttributeId,
...
EmberAfRf4ceGdpAttributeStatus emberAfPluginRf4ceZrc20HaServerSetHaAttribute(int8u pairingIndex,
                                                                             int8u haInstanceId,
                                                                             int8u haAttributeId,
                                                                             EmberAfRf4ceZrcHomeAutomationAttribute *haAttribute)
{
...
int8u emberAfPluginRf4ceZrc20HaLogicalDeviceDestinationTableSize(void)
{
    return EMBER_AF_PLUGIN_RF4CE_ZRC20_HA_SERVER_LOGICAL_DEVICES_TABLE_SIZE;
}

EmberStatus emberAfPluginRf4ceZrc20HaLogicalDeviceDestinationGet(int8u pairingIndex,
                                                                 int8u haInstanceId,
                                                                 DestStruct* dest)
{
 ...
 */
EmberStatus emberAfPluginRf4ceZrc20HaLogicalDeviceAndInstanceToLogicalDeviceMappingAdd(int8u pairingIndex,
                                                                                       int8u haInstanceId,
                                                                                       DestStruct* dest)
{
  int8u i = 0;
                              ...
                              EmberAfRf4ceGdpHeartbeatTrigger trigger)
{
  ...
  for(instanceId=0; instanceId<ZRC_HA_SERVER_NUM_OF_HA_INSTANCES; instanceId++) {
    ...
    int8u payload[CLIENT_NOTIFICATION_REQUEST_HA_PULL_PAYLOAD_LENGTH];
    int8u index = 0;
    int8u i;
...
//          & HA_ATTRIBUTE_STATUS_CHANGED_FLAG) {
      if (READBIT(aplHaAttributesStatusTable[pairingIndex][instanceId][i/8],
                  i & 0x07)) {
        int8u byte = (aplHaAttributesInfoTable[i].id / 8)
            + CLIENT_NOTIFICATION_REQUEST_HA_PULL_HA_ATTRIBUTE_DIRTY_FLAGS_OFFSET;
        int8u bit = (aplHaAttributesInfoTable[i].id & 0x07);
