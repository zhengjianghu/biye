...
#if defined(EMBER_SCRIPTED_TEST)
#define HIDDEN
int32u localNodeZrcCapabilities;
#else
...
boolean emAfRf4ceZrcIncomingPullAttributesResponseActionMappingClientCallback(void);
...
boolean emAfRf4ceZrcIncomingPushAttributesActionMappingServerCallback(void);
boolean emAfRf4ceZrcIncomingPullAttributesActionMappingServerCallback(void);
...
boolean emAfRf4ceZrcIncomingPushAttributesHomeAutomationRecipientCallback(void);
boolean emAfRf4ceZrcIncomingPullAttributesHomeAutomationRecipientCallback(void);
...
boolean emAfRf4ceZrcIncomingPullAttributesResponseHomeAutomationOriginatorCallback(void);
#endif // EMBER_AF_RF4CE_ZRC_IS_HA_ACTIONS_ORIGINATOR

//------------------------------------------------------------------------------
// Forward declarations and local enums.

static const EmAfRf4ceZrcAttributeDescriptor *getAttributeDescriptor(int8u attrId);
static int16u getAttributeSize(int8u attributeId,
                               int8u pairingIndex,
                               int16u entryId);
static boolean isAttributeSupported(int8u attributeId,
                                    boolean isLocal);
static void handleIncomingGetOrPullAttributesCommand(boolean isGet);
static void handleIncomingGetOrPullAttributesResponseCommand(boolean isGet);
static void handleIncomingSetOrPushAttributesCommand(boolean isSet);
...
HIDDEN const int16u localIRDBVendorSupport[] = EMBER_AF_RF4CE_ZRC_IRDB_VENDOR_IDS;
...
HIDDEN int16u remoteIRDBVendorSupport[EMBER_AF_PLUGIN_RF4CE_ZRC20_REMOTE_IRDB_VENDORS_SUPPORTED_TABLE_SIZE];
...
void emAfRf4ceZrcReadOrWriteAttribute(int8u pairingIndex,
                                      int8u attrId,
                                      int16u entryIdOrValueLength,
                                      boolean isRead,
                                      int8u *val)
{
  boolean localAttributes = (pairingIndex == 0xFF);
  ...
  if (isRead) {
    ...
    {
      int32u cababilities = ((pairingIndex == 0xFF)
    ...
    case EMBER_AF_RF4CE_ZRC_ATTRIBUTE_IRDB_VENDOR_SUPPORT:
    {
      ...
      int8u i;
      int8u entriesNum = (localAttributes
    ...
    {
      int8u *attrPtr = emAfRf4ceZrcGetActionCodesAttributePointer(attrId,
...
boolean emAfRf4ceZrcIsArrayedAttributeSupported(int8u attrId,
                                                int16u entryId,
                                                int8u pairingIndex)
{
...
int8u *emAfRf4ceZrcGetActionCodesAttributePointer(int8u attrId,
                                                  int16u entryId,
                                                  int8u pairingIndex)
{
  boolean isLocalAttribute = (pairingIndex == 0xFF);
...
static void handleIncomingGetOrPullAttributesCommand(boolean isGet)
{
  ...
  while(emAfRf4ceGdpFetchAttributeIdentificationRecord(&idRecord)) {
    ...
    boolean isArrayed = IS_ARRAY_ATTRIBUTE(attributeId);
    int8u attributeVal[MAX_ZRC_ATTRIBUTE_SIZE];
    ...
    statusRecord.value = (int8u*)attributeVal;
