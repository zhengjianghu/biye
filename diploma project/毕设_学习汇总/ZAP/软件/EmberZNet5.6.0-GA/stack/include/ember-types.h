...
#define emberIsZigbeeBroadcastAddress(address) \
 (EMBER_MIN_BROADCAST_ADDRESS <= ((int16u) (address)))
...
#else
typedef int8u EmberEndDeviceConfiguration;
enum
#endif
{
...
#endif
{
  ...
  EMBER_VERIFY_REQUESTED_LINK_KEY     = 0x0400,
...
#endif
{
  ...
  EMBER_WAITING_TO_VERIFY_TRANSIENT_KEY   = 128,

  // Other requester failures
  EMBER_FAILED_TO_STORE_TRANSIENT_LINK_KEY   = 200,  
  EMBER_FAILED_TO_STORE_PERMANENT_LINK_KEY   = 201,
  EMBER_TIMEOUT_TO_VERIFY_TRANSIENT_LINK_KEY = 202,
  EMBER_FAILED_TO_VERIFY_LINK_KEY            = 203,
};
