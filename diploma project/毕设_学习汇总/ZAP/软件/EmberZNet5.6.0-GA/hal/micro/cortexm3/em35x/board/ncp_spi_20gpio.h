 ...
 * break the link!).
 */
#define EZSP_PIN_BLACKOUT_MASK  ((((int32u)1)<<PORTB_PIN(2))|  /*HOST_MOSI */ \
                                 (((int32u)1)<<PORTB_PIN(1))|  /*HOST_MISO */ \
                                 (((int32u)1)<<PORTB_PIN(3))|  /*HOST_SCLK */ \
                                 (((int32u)1)<<PORTB_PIN(4))|  /*HOST_nSEL */ \
                                 (((int32u)1)<<PORTC_PIN(7))|  /*HOST_nINT */ \
                                 (((int32u)1)<<PORTB_PIN(0)))  /*HOST_nWAKE*/
