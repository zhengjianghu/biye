...
typedef union {
  struct
  {
    ...
    int32u DMA_IRQn       : 1;  // B0
    int32u GPIO_EVEN_IRQn : 1;  // B1
    int32u TIMER0_IRQn    : 1;  // B2
    int32u USART0_RX_IRQn : 1;  // B3
    int32u USART0_TX_IRQn : 1;  // B4
    int32u USB_IRQn       : 1;  // B5
    int32u ACMP0_IRQn     : 1;  // B6
    int32u ADC0_IRQn      : 1;  // B7
    int32u DAC0_IRQn      : 1;  // B8
    int32u I2C0_IRQn      : 1;  // B9
    int32u I2C1_IRQn      : 1;  // B10
    int32u GPIO_ODD_IRQn  : 1;  // B11
    int32u TIMER1_IRQn    : 1;  // B12
    int32u TIMER2_IRQn    : 1;  // B13
    int32u TIMER3_IRQn    : 1;  // B14
    int32u USART1_RX_IRQn : 1;  // B15
    int32u USART1_TX_IRQn : 1;  // B16
    int32u LESENSE_IRQn   : 1;  // B17
    int32u USART2_RX_IRQn : 1;  // B18
    int32u USART2_TX_IRQn : 1;  // B19
    int32u UART0_RX_IRQn  : 1;  // B20
    int32u UART0_TX_IRQn  : 1;  // B21
    int32u UART1_RX_IRQn  : 1;  // B22
    int32u UART1_TX_IRQn  : 1;  // B23
    int32u LEUART0_IRQn   : 1;  // B24
    int32u LEUART1_IRQn   : 1;  // B25
    int32u LETIMER0_IRQn  : 1;  // B26
    int32u PCNT0_IRQn     : 1;  // B27
    int32u PCNT1_IRQn     : 1;  // B28
    int32u PCNT2_IRQn     : 1;  // B29
    int32u RTC_IRQn       : 1;  // B30
    int32u BURTC_IRQn     : 1;  // B31
    int32u CMU_IRQn       : 1;  // B32
    int32u VCMP_IRQn      : 1;  // B33
    int32u LCD_IRQn       : 1;  // B34
    int32u MSC_IRQn       : 1;  // B35
    int32u AES_IRQn       : 1;  // B36
    int32u EBI_IRQn       : 1;  // B37
    int32u EMU_IRQn       : 1;  // B38
    int32u                : 25; // B39-63
  } bits;
  int32u word[2];
#elif defined (_EFR_DEVICE)
    int32u EMU_IRQn         : 1;  // B0
    int32u FRC_PRI_IRQn     : 1;  // B1
    int32u FRC_IRQn         : 1;  // B2
    int32u MODEM_IRQn       : 1;  // B3
    int32u RAC_SEQ_IRQn     : 1;  // B4
    int32u RAC_RSM_IRQn     : 1;  // B5
    int32u BUFC_IRQn        : 1;  // B6
    int32u LDMA_IRQn        : 1;  // B7
    int32u GPIO_EVEN_IRQn   : 1;  // B8
    int32u TIMER0_IRQn      : 1;  // B9
    int32u USART0_RX_IRQn   : 1;  // B10
    int32u USART0_TX_IRQn   : 1;  // B11
    int32u ACMP0_IRQn       : 1;  // B12
    int32u ADC0_IRQn        : 1;  // B13
    int32u IDAC0_IRQn       : 1;  // B14
    int32u I2C0_IRQn        : 1;  // B15
    int32u GPIO_ODD_IRQn    : 1;  // B16
    int32u TIMER1_IRQn      : 1;  // B17
    int32u USART1_RX_IRQn   : 1;  // B18
    int32u USART1_TX_IRQn   : 1;  // B19
    int32u LEUART0_IRQn     : 1;  // B20
    int32u PCNT0_IRQn       : 1;  // B21
    int32u CMU_IRQn         : 1;  // B22
    int32u MSC_IRQn         : 1;  // B23
    int32u CRYPTO_IRQn      : 1;  // B24
    int32u LETIMER0_IRQn    : 1;  // B25
    int32u AGC_IRQn         : 1;  // B26
    int32u PROTIMER_IRQn    : 1;  // B27
    int32u RTCC_IRQn        : 1;  // B28
    int32u SYNTH_IRQn       : 1;  // B29
    int32u CRYOTIMER_IRQn   : 1;  // B30
    int32u RFSENSE_IRQn     : 1;  // B31
    int32u FPUEH_IRQn       : 1;  // B32
    int32u WDOG_IRQn        : 1;  // B33
    int32u                : 30; // B34-63
  } bits;
  int32u word[2];
