 ...
 */
  ...
  #include "em35x/em341/wake-gpio.h"
#elif defined(CORTEXM3_EM342)
  #include "em35x/em342/wake-gpio.h"
  ...
  #include "efm32/efm32lg990f256/wake-gpio.h"
#elif defined(CORTEXM3_EFR32)
  #include "efm32/efr32/wake-gpio.h"
#elif defined(CORTEXM3_EZR32LG230F256)
  #include "efm32/ezr32lg230f256/wake-gpio.h"
#endif
