 ...
 */
  ...
  #define CONFIGURE_EEPROM_POWER_PIN()  do { halGpioSetConfig(PORTC_PIN(7), GPIOCFG_OUT); } while (0)
  #define SET_EEPROM_POWER_PIN()        do { GPIO_PCSET = PC7; } while (0)
  #define CLR_EEPROM_POWER_PIN()        do { GPIO_PCCLR = PC7; } while (0)
#endif
