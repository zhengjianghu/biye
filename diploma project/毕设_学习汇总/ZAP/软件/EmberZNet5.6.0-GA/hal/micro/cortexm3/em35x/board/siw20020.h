 ...
 */
#if     (defined(EZSP_SPI) || defined(EZSP_UART))
#define RHO_GPIO              PORTB_PIN(6) // Ensure RHO configured for NCP
#else//!(defined(EZSP_SPI) || defined(EZSP_UART))
//#define RHO_GPIO              PORTB_PIN(6)
#endif//(defined(EZSP_SPI) || defined(EZSP_UART))
/**
...
// GPIO configuration is the same for RHO and BUTTON0, simplifying things
  ...
  extern int8u WAKE_ON_DFL_RHO_VAR;
 ...
 * the NCP interface.
 */
#define EZSP_PIN_BLACKOUT_MASK  ((1<<PORTA_PIN(0))|  /*PRO2_SDI       */ \
                                 (1<<PORTA_PIN(1))|  /*PRO2_SDO       */ \
                                 (1<<PORTA_PIN(2))|  /*PRO2_SCLK      */ \
                                 (1<<PORTA_PIN(3))|  /*PRO2_nSEL      */ \
                                 (1<<PORTA_PIN(6))|  /*PRO2_SDN       */ \
                                 (1<<PORTA_PIN(7))|  /*PRO2_nIRQ      */ \
                                 (1<<PORTB_PIN(0))|  /*HOST_nWAKE     */ \
                                 (1<<PORTB_PIN(1))|  /*HOST_MISO/TXD  */ \
                                 (1<<PORTB_PIN(2))|  /*HOST_MOSI/RXD  */ \
                                 (1<<PORTB_PIN(3))|  /*HOST_SCLK/nCTS */ \
                                 (1<<PORTB_PIN(4))|  /*HOST_nSEL/nRTS */ \
                                 (1<<PORTC_PIN(7)))  /*HOST_nINT      */
...
const int8u pro2SpiPort = PRO2_SPI_PORT;                                      \
const int8u pro2SpiClockMHz = PRO2_SPI_MHZ;                                   \
const int8u pro2GpioCfgPowerUp[] = { PRO2_POWERUP_GPIO_CFG() };               \
int8s phy2PtiGpio = PRO2_PTI_GPIO;                                            \
