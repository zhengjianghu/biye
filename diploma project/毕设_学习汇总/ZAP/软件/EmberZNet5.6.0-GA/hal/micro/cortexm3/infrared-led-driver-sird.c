...
static const int8u samsungPowerToggle[] =
{
  // Header
...
static void frameNibblesToBytes(int8u *pSrc, int8u *pDst, int8u uBitCount)
{
  int8u i;
...
{
  int8u i;
  int8u byteCntHeader = 10;
  int8u byteCntTiming = 0;
  int8u byteCntFirst = 0;
  int8u byteCntRepeate = 0;
  int8u byteCntRelease = 0;
  int8u byteCntToggleT = 0;
  int8u byteCntToggle = 0;
  int8u expectedLen = 0;
