 ...
 */
  ...
  #define CONFIGURE_EEPROM_POWER_PIN()  do { halGpioSetConfig(PORTC_PIN(1), GPIOCFG_OUT); } while (0)
  #define SET_EEPROM_POWER_PIN()        do { GPIO_PCSET = PC1; } while (0)
  #define CLR_EEPROM_POWER_PIN()        do { GPIO_PCCLR = PC1; } while (0)
#endif
...
extern int16u gpioCfgPowerUp[9];
extern int16u gpioCfgPowerDown[9];
...
extern int8u gpioOutPowerUp[5];
extern int8u gpioOutPowerDown[5];
...
int32u gpioRadioPowerBoardMask = {( BIT32(PORTB_PIN(0)) /* FEM_CPS */          \
