...
//=============================================================================
  ...
  #endif
#endif
VAR_AT_SEGMENT(NO_STRIPPING int32u cstackMemory[CSTACK_SIZE], __CSTACK__);
  ...
  VAR_AT_SEGMENT(NO_STRIPPING int8u guardRegionPlaceHolder[HEAP_GUARD_REGION_SIZE_BYTES], __GUARD_REGION__);
#endif
...
// bootloader then create an array here to hold a place for this data.
  ...
  VAR_AT_SEGMENT(NO_STRIPPING int8u internalStorage[INTERNAL_STORAGE_SIZE_B], __INTERNAL_STORAGE__);
#endif
