...
extern int8u *EPOUTBUF[7];
extern int8u *EPINBUF[7];
extern volatile int32u *EPOUTBUFSIZE[7];
extern volatile int32u *EPINBUFSIZE[7];

extern boolean usbVbusPresent;
                                   ...
                                   USBD_Ep_TypeDef *ep, uint16_t *halt )
{
  ...
  {
    *halt = USB_STALLIN & (USB_STALLOUTEP0 << ep->num) ? 1: 0;
    retVal = USB_STATUS_OK;
  }
